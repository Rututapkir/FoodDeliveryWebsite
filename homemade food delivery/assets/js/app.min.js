...
!function(e, t) {
    ...
    var o, s, r = function(e) {
        ...
        Object.keys(i).forEach((function(n) {
            var o, s = i[n], r = t[n], a = r && f(r) ? "element" : null == (o = r) ? "" + o : {}.toString.call(o).match(/\s([a-z]+)/i)[1].toLowerCase();
            if (!new RegExp(s).test(a))
                throw new Error(e.toUpperCase() + ': Option "' + n + '" provided type "' + a + '" but expected type "' + s + '".')
        }
        ))
    }, m = function(e) {
        if (!e)
    ...
    }, _ = "rtl" === document.documentElement.dir, w = (o = {},
    s = 1,
    {
        set: function(e, t, i) {
    ...
    function M(e, t, i) {
        ...
        for (var n = Object.keys(e), o = 0, s = n.length; o < s; o++) {
            var r = e[n[o]];
            if (r.originalHandler === t && r.delegationSelector === i)
                return r
        }
        return null
    }
    ...
    function L(e, t, i, n, o) {
        var s = M(t[i], n, o);
        s && (e.removeEventListener(i, s, Boolean(o)),
    ...
    var W = {
        ...
        trigger: function(e, t, i) {
            if ("string" != typeof t || !e)
                return null;
            var n, o = y(), s = t.replace(S, ""), r = t !== s, a = P.has(s), l = !0, d = !0, c = !1, u = null;
            return r && o && (n = o.Event(t, i),
            o(e).trigger(n),
            l = !n.isPropagationStopped(),
            d = !n.isImmediatePropagationStopped(),
            c = n.isDefaultPrevented()),
            a ? (u = document.createEvent("HTMLEvents")).initEvent(s, l, !0) : u = new CustomEvent(t,{
                bubbles: l,
                cancelable: !0
            }),
      ...
      , F = function() {
        function e(e) {
            e && (this._element = e,
            x(e, this.constructor.DATA_KEY, this))
        }
    ...
    var N = {
      ...
      , J = function(e) {
        ...
        s._slide = function(e, t) {
            var i, n, o, s = this, r = Y.findOne(".active.carousel-item", this._element), a = this._getItemIndex(r), l = t || r && this._getItemByDirection(e, r), d = this._getItemIndex(l), u = Boolean(this._interval);
            if ("next" === e ? (i = "carousel-item-start",
            n = "carousel-item-next",
            o = "left") : (i = "carousel-item-end",
            ...
            l && l.classList.contains("active"))
                ...
                this._element.classList.contains("slide")) {
                    ...
                    l.classList.add("active"),
                    this._isSliding = !1,
                    W.trigger(this._element, "slid.bs.carousel", {
                        relatedTarget: l,
                        direction: o,
                        from: a,
                        to: d
    ...
    W.on(window, "load.bs.carousel.data-api", (function() {
        for (var e = Y.find('[data-bs-ride="carousel"]'), t = 0, i = e.length; t < i; t++)
            J.carouselInterface(e[t], k(e[t], "bs.carousel"))
    }
    )),
    b((function() {
        var e = y();
    ...
    var V = "collapse"
      ...
      , ee = function(e) {
            ...
            if (!this._isTransitioning && !this._element.classList.contains("show")) {
                ...
                if (!W.trigger(this._element, "show.bs.collapse").defaultPrevented) {
                    ...
                    W.one(this._element, "transitionend", (function() {
                        ...
                        W.trigger(e._element, "shown.bs.collapse")
                    }
                    )),
                    h(this._element, l),
        ...
        s.hide = function() {
            ...
            if (!this._isTransitioning && this._element.classList.contains("show") && !W.trigger(this._element, "hide.bs.collapse").defaultPrevented) {
                ...
                W.one(this._element, "transitionend", (function() {
                    ...
                    W.trigger(e._element, "hidden.bs.collapse")
                }
                )),
                h(this._element, r)
            }
        ...
        ,
        s._getConfig = function(e) {
            return (e = i({}, K, e)).toggle = Boolean(e.toggle),
            p(V, e, Z),
            e
        }
        ,
        ...
        o.collapseInterface = function(e, t) {
            ...
            if (!n && s.toggle && "string" == typeof t && /show|hide/.test(t) && (s.toggle = !1),
            n || (n = new o(e,s)),
            "string" == typeof t) {
                if (void 0 === n[t])
        ...
        fn: function(e) {
            ...
            Object.keys(t.elements).forEach((function(e) {
                var i = t.styles[e] || {}
                  , n = t.attributes[e] || {}
                  , o = t.elements[e];
                fe(o) && de(o) && (Object.assign(o.style, i),
        ...
        effect: function(e) {
            ...
            function() {
                Object.keys(t.elements).forEach((function(e) {
                    ...
                    fe(n) && de(n) && (Object.assign(n.style, s),
    ...
    function we(e) {
        if (!fe(e) || "fixed" === ve(e).position)
            return null;
        var t = e.offsetParent;
        if (t) {
            var i = be(t);
            if ("body" === de(t) && "static" === ve(t).position && "static" !== ve(i).position)
                return i
        }
        return t
    }
    ...
    var Oe = {
        ...
        phase: "main",
        fn: function(e) {
            var t, i = e.state, n = e.name, o = i.elements.arrow, s = i.modifiersData.popperOffsets, r = pe(i.placement), a = ke(r), l = [oe, ne].indexOf(r) >= 0 ? "height" : "width";
            if (o && s) {
        ...
        effect: function(e) {
            var t = e.state
              ...
              , r = i.padding
              , a = void 0 === r ? 0 : r;
            null != s && ("string" != typeof s || (s = t.elements.popper.querySelector(s))) && ge(t.elements.popper, s) && (t.elements.arrow = s,
    ...
    function je(e) {
        var t, i = e.popper, n = e.popperRect, o = e.placement, s = e.offsets, r = e.position, a = e.gpuAcceleration, l = e.adaptive, d = function(e) {
            var t = e.x
              , i = e.y
        ...
        }(s), c = d.x, u = d.y, f = s.hasOwnProperty("x"), h = s.hasOwnProperty("y"), p = oe, m = te, g = window;
        if (l) {
            var v = xe(i);
            v === ce(i) && (v = be(i)),
            o === te && (m = ie,
            u -= v.clientHeight - n.height,
            u *= a ? 1 : -1),
            o === oe && (p = ne,
        ...
        return a ? Object.assign(Object.assign({}, b), {}, ((y = {})[m] = h ? "0" : "",
        y[p] = f ? "0" : "",
        y.transform = (g.devicePixelRatio || 1) < 2 ? "translate(" + c + "px, " + u + "px)" : "translate3d(" + c + "px, " + u + "px, 0)",
        y)) : Object.assign(Object.assign({}, b), {}, ((t = {})[m] = h ? u + "px" : "",
        t[p] = f ? c + "px" : "",
        t.transform = "",
        t))
    }
    ...
    function Ye(e) {
        var t, i = e.reference, n = e.element, o = e.placement, s = o ? pe(o) : null, r = o ? Ne(o) : null, a = i.x + i.width / 2 - n.width / 2, l = i.y + i.height / 2 - n.height / 2;
        switch (s) {
        case te:
            t = {
                x: a,
    ...
    function et(e, t, i) {
        void 0 === i && (i = !1);
        var n, o, s = be(t), r = We(e), a = fe(t), l = {
            scrollLeft: 0,
            scrollTop: 0
        }, d = {
            x: 0,
        ...
        fe(t) ? ((d = We(t)).x += t.clientLeft,
        d.y += t.clientTop) : s && (d.x = Re(s))),
        {
        ...
        return function(e, t, i) {
            ...
            var o, r, a = {
                ...
                setOptions: function(i) {
                    u(),
                    a.options = Object.assign(Object.assign(Object.assign({}, s), a.options), i),
                    a.scrollParents = {
                        reference: ue(e) ? qe(e) : e.contextElement ? qe(e.contextElement) : [],
                        popper: qe(t)
                    };
    ...
    var ot = nt()
      , st = nt({
        defaultModifiers: [Ee, Ke, Pe, he]
    })
      , rt = nt({
        defaultModifiers: [Ee, Ke, Pe, he, Ve, Ue, Ze, Oe, Je]
    })
      , at = Object.freeze({
        __proto__: null,
        popperGenerator: nt,
      ...
      , yt = function(e) {
            ...
            if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                ...
                if (!W.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                    if (!this._inNavbar) {
                        ...
                        var i = this._element;
                        "parent" === this._config.reference ? i = e : f(this._config.reference) && (i = this._config.reference,
        ...
        s.hide = function() {
            if (!this._element.disabled && !this._element.classList.contains("disabled") && this._menu.classList.contains("show")) {
                ...
                W.trigger(e, "hide.bs.dropdown", t).defaultPrevented || (this._popper && this._popper.destroy(),
                this._menu.classList.toggle("show"),
                this._element.classList.toggle("show"),
                W.trigger(e, "hidden.bs.dropdown", t))
            }
        }
        ,
        s.dispose = function() {
            e.prototype.dispose.call(this),
            W.off(this._element, ".bs.dropdown"),
            this._menu = null,
        ...
        ,
        s._getConfig = function(e) {
            return e = i({}, this.constructor.Default, N.getDataAttributes(this._element), e),
            p(lt, e, this.constructor.DefaultType),
            e
        }
        ,
        ...
        o.dropdownInterface = function(e, t) {
            ...
            if (i || (i = new o(e,"object" == typeof t ? t : null)),
            "string" == typeof t) {
                if (void 0 === i[t])
                    throw new TypeError('No method named "' + t + '"');
                i[t]()
        ...
        o.clearMenus = function(e) {
            if (!e || 2 !== e.button && ("keyup" !== e.type || "Tab" === e.key))
                for (var t = Y.find('[data-bs-toggle="dropdown"]'), i = 0, n = t.length; i < n; i++) {
                    ...
                    r) {
                        var l, d = r._menu;
                        if (t[i].classList.contains("show") && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && "Tab" === e.key) && d.contains(e.target) || W.trigger(s, "hide.bs.dropdown", a).defaultPrevented))
        ...
        o.dataApiKeydownHandler = function(e) {
            if (!(/input|textarea/i.test(e.target.tagName) ? "Space" === e.key || "Escape" !== e.key && ("ArrowDown" !== e.key && "ArrowUp" !== e.key || e.target.closest(".dropdown-menu")) : !dt.test(e.key)) && (e.preventDefault(),
            e.stopPropagation(),
    ...
    var bt = {
      ...
      , wt = function(e) {
        ...
        s.hide = function(e) {
            ...
            this._isShown && !this._isTransitioning && !W.trigger(this._element, "hide.bs.modal").defaultPrevented) {
                this._isShown = !1;
        ...
        s._showElement = function(e) {
            ...
            var o = function() {
                ...
                W.trigger(t._element, "shown.bs.modal", {
                    relatedTarget: e
                })
            };
            if (i) {
                var s = c(this._dialog);
                W.one(this._dialog, "transitionend", o),
                h(this._dialog, s)
            } else
                o()
        }
        ...
        s._hideModal = function() {
            ...
            this._showBackdrop((function() {
                ...
                e._resetAdjustments(),
                e._resetScrollbar(),
                W.trigger(e._element, "hidden.bs.modal")
            }
            ))
        }
        ,
        ...
        s._showBackdrop = function(e) {
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                W.one(this._backdrop, "transitionend", e),
                h(this._backdrop, n)
                ...
                if (this._element.classList.contains("fade")) {
                    ...
                    W.one(this._backdrop, "transitionend", o),
                    h(this._backdrop, s)
                } else
                    o()
            } else
        ...
        s._triggerBackdropTransition = function() {
            ...
            if (!W.trigger(this._element, "hidePrevented.bs.modal").defaultPrevented) {
                ...
                W.one(this._element, "transitionend", (function() {
                    ...
                    t || (W.one(e._element, "transitionend", (function() {
        ...
        s._setScrollbar = function() {
            ...
            if (this._isBodyOverflowing) {
                Y.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach((function(t) {
                    ...
                    N.setDataAttribute(t, "padding-right", i),
        ...
        s._resetScrollbar = function() {
            Y.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach((function(e) {
                ...
                void 0 !== t && (N.removeDataAttribute(e, "padding-right"),
                e.style.paddingRight = t)
            }
            )),
            Y.find(".sticky-top").forEach((function(e) {
                var t = N.getDataAttribute(e, "margin-right");
                void 0 !== t && (N.removeDataAttribute(e, "margin-right"),
                e.style.marginRight = t)
            }
            ));
            var e = N.getDataAttribute(document.body, "padding-right");
            void 0 === e ? document.body.style.paddingRight = "" : (N.removeDataAttribute(document.body, "padding-right"),
    ...
    function St(e, t, i) {
        ...
        for (var o = (new window.DOMParser).parseFromString(e, "text/html"), s = Object.keys(t), r = (n = []).concat.apply(n, o.body.querySelectorAll("*")), a = function(e, i) {
            var n, o = r[e], a = o.nodeName.toLowerCase();
            if (!s.includes(a))
            ...
            l.forEach((function(e) {
                (function(e, t) {
                    ...
                    if (t.includes(i))
                        return !xt.has(i) || Boolean(e.nodeValue.match(kt) || e.nodeValue.match(Tt));
      ...
      , Mt = function(e) {
        ...
        s.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                "ontouchstart"in document.documentElement && (f = []).concat.apply(f, document.body.children).forEach((function(e) {
                ...
                var m = function() {
                    var t = e._hoverState;
                    e._hoverState = null,
                    W.trigger(e._element, e.constructor.Event.SHOWN),
                    "out" === t && e._leave(null, e)
                };
                if (this.tip.classList.contains("fade")) {
                    var g = c(this.tip);
                    W.one(this.tip, "transitionend", m),
                    h(this.tip, g)
                } else
                    m()
            }
        ...
        s.setElementContent = function(e, t) {
            if (null !== e)
                return "object" == typeof t && f(t) ? (t.jquery && (t = t[0]),
                void (this.config.html ? t.parentNode !== e && (e.innerHTML = "",
                e.appendChild(t)) : e.textContent = t.textContent)) : void (this.config.html ? (this.config.sanitize && (t = St(t, this.config.allowList, this.config.sanitizeFn)),
        ...
        s._enter = function(e, t) {
            ...
            (t = t || k(e.delegateTarget, i)) || (t = new this.constructor(e.delegateTarget,this._getDelegateConfig()),
      ...
      , Ht = function(e) {
        ...
        o.jQueryInterface = function(e) {
            return this.each((function() {
                ...
                if (t || (t = new o(this,"object" == typeof e && e)),
                "string" == typeof e) {
                    if (void 0 === t[e])
                        throw new TypeError('No method named "' + e + '"');
                    t[e]()
    ...
    var Nt = function(e) {
        ...
        return o.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains("active") || this._element.classList.contains("disabled"))) {
                var t, i = d(this._element), n = this._element.closest(".nav, .list-group");
                if (n) {
    ...
    W.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', (function(e) {
        e.preventDefault(),
        (k(this, "bs.tab") || new Nt(this)).show()
    }
    )),
    b((function() {
        var e = y();
    ...
    var Yt = {
      ...
      , Ut = function(e) {
        ...
        return s.show = function() {
            ...
            if (!W.trigger(this._element, "show.bs.toast").defaultPrevented) {
                ...
                this._config.animation) {
                    ...
                    W.one(this._element, "transitionend", t),
                    h(this._element, i)
                } else
                    t()
            }
        ...
        s.hide = function() {
            ...
            if (this._element.classList.contains("show") && !W.trigger(this._element, "hide.bs.toast").defaultPrevented) {
                var t = function() {
                    ...
                    W.trigger(e._element, "hidden.bs.toast")
                };
        ...
        s.dispose = function() {
            ...
            W.off(this._element, "click.dismiss.bs.toast"),
            e.prototype.dispose.call(this),
            this._config = null
        }
        ,
...
function(e, t) {
    ...
    function n(e, t, o) {
        ...
        d ? (this.elements = (s = d,
        Array.isArray(s) ? s : "object" == typeof s && "number" == typeof s.length ? l.call(s) : [s]),
        this.options = i({}, this.options),
        "function" == typeof t ? o = t : i(this.options, t),
        o && this.on("always", o),
        this.getImages(),
        r && (this.jqDeferred = new r.Deferred),
        void setTimeout(this.check.bind(this))) : void a.error("Bad element for imagesLoaded " + (d || e))
    }
    function o(e) {
        this.img = e
    }
            ...
            (t = this).each((function(e, t) {
                ...
                if (o) {
                    ...
                    if (s && "_" != n.charAt(0)) {
                        ...
                        r(c + " is not a valid method")
                } else
                    r(i + " not initialized. Cannot call methods, i.e. " + c)
            }
            )),
            void 0 !== d ? d : t
        }
...
function(e, t) {
    ...
    i.create = function(e, t) {
        ...
        return (o.prototype = Object.create(n)).constructor = o,
        t && (o.options = t),
...
function(e, t) {
    ...
    n._getItemLayoutPosition = function(e) {
        ...
        for (var n = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](i, e), o = {
            ...
            y: n.y
        }, s = n.y + e.size.outerHeight, r = i + n.col, a = n.col; a < r; a++)
            this.colYs[a] = s;
        return o
    }
    ,
...
function(e, t) {
    ...
    var u = function(e) {
        if ("string" != typeof e)
            return e;
        var t, i, n = l(e).split(" "), o = n[0], s = o.match(/^\[(.+)\]$/), r = s && s[1], a = (i = o,
        (t = r) ? function(e) {
            ...
            function(e, t) {
                for (var o = 0; o < i.length; o++) {
                    var s = i[o]
                      ...
                      , a = t.sortData[s];
                    if (a < r || r < a)
                        return (a < r ? 1 : -1) * ((void 0 !== n[s] ? n[s] : n) ? 1 : -1)
                }
                return 0
            }
            );
    ...
    t.prototype.refresh = function() {
        ...
        e = {
            ...
            for (var a in this.waypoints[s]) {
                var l, d, c, u, f = this.waypoints[s][a], h = f.options.offset, p = f.triggerPoint, m = 0, g = null == p;
                ...
                u = !d && !c,
                !g && (d && c) ? (f.queueTrigger(r.backward),
                n[f.group.id] = f.group) : (!g && u || g && r.oldScroll >= f.triggerPoint) && (f.queueTrigger(r.forward),
...
function() {
    ...
    i = function(e) {
        ...
        t = 1; t < arguments.length; t++)
            if (n = arguments[t])
                for (var o in n)
                    n.hasOwnProperty(o) && ("object" == typeof n[o] ? i(e[o], n[o]) : e[o] = n[o]);
        return e
    }
    ,
    n = function(e, t) {
    ...
    (DateFormatter = function(e) {
        ...
        getMonth: function(e) {
            var t;
            return 0 === (t = n(e, this.dateSettings.monthsShort) + 1) && (t = n(e, this.dateSettings.months) + 1),
            t
        },
        parseDate: function(t, i) {
            var n, o, s, r, a, l, d, c, u, f, h = this, p = !1, m = !1, g = h.dateSettings, v = {
                date: null,
                year: null,
                month: null,
                day: null,
            ...
            if (t instanceof Date)
                return t;
            if ("U" === i)
                return (s = parseInt(t)) ? new Date(1e3 * s) : t;
            switch (typeof t) {
            case "number":
                return new Date(t);
            case "string":
            ...
            for (o = t.replace(h.separators, "\0").split("\0"),
            s = 0; s < o.length; s++)
                switch (r = o[s],
                a = parseInt(r),
                n[s]) {
                ...
                case "Y":
                    if (!a)
                        return null;
                    u = r.length,
                    v.year = 2 === u ? parseInt((a < 70 ? "20" : "19") + r) : a,
                    p = !0;
                    break;
                case "m":
                case "n":
                ...
                case "g":
                case "h":
                    if (f = o[d = -1 < n.indexOf("a") ? n.indexOf("a") : -1 < n.indexOf("A") ? n.indexOf("A") : -1],
                    -1 < d)
                        c = e(f, g.meridiem[0]) ? 0 : e(f, g.meridiem[1]) ? 12 : -1,
                        1 <= a && a <= 12 && -1 < c ? v.hour = a + c - 1 : 0 <= a && a <= 23 && (v.hour = a);
                    else {
                        if (!(0 <= a && a <= 23))
                            return null;
                        v.hour = a
            ...
            if (!0 === p && v.year && v.month && v.day)
                v.date = new Date(v.year,v.month - 1,v.day,v.hour,v.min,v.sec,0);
            else {
                if (!0 !== m)
                    return null;
        ...
        guessDate: function(e, t) {
            if ("string" != typeof e)
                return e;
            var i, n, o, s, r, a, l = e.replace(this.separators, "\0").split("\0"), d = t.match(this.validParts), c = new Date, u = 0;
            if (!/^[djmn]/g.test(d[0]))
                return e;
            for (o = 0; o < l.length; o++) {
                if (u = 2,
                r = l[o],
                a = parseInt(r.substr(0, 2)),
                isNaN(a))
                    return null;
                switch (o) {
                case 0:
                ...
                case 2:
                    if (n = c.getFullYear(),
                    u = (i = r.length) < 4 ? i : 4,
                    !(n = parseInt(i < 4 ? n.toString().substr(0, 4 - i) + r : r.substr(0, 4))))
                        return null;
                    c.setFullYear(n);
                    break;
                case 3:
        ...
        parseFormat: function(e, i) {
            var n, o = this, s = o.dateSettings, r = /\\?(.?)/gi, a = function(e, t) {
                return n[e] ? n[e]() : t
            };
            return n = {
                d: function() {
        ...
        formatDate: function(e, t) {
            ...
            if (e instanceof Date) {
                for (o = t.length,
                i = 0; i < o; i++)
                    "S" !== (r = t.charAt(i)) && "\\" !== r && (0 < i && "\\" === t.charAt(i - 1) ? a += r : (s = this.parseFormat(r, e),
                    i !== o - 1 && this.intParts.test(r) && "S" === t.charAt(i + 1) && (n = parseInt(s) || 0,
                    s += this.dateSettings.ordinal(n)),
                    a += s));
                return a
            }
            return ""
...
var datetimepickerFactory = function(e) {
    ...
    e.fn.xdsoftScroller = function(t, i) {
        return this.each((function() {
            var n, o, s, r, a, l = e(this), d = function(e) {
                var t, i = {
                    x: 0,
                    y: 0
                };
                ...
                i.x = t.clientX,
                i.y = t.clientY) : "mousedown" !== e.type && "mouseup" !== e.type && "mousemove" !== e.type && "mouseover" !== e.type && "mouseout" !== e.type && "mouseenter" !== e.type && "mouseleave" !== e.type || (i.x = e.clientX,
                i.y = e.clientY),
                i
            }, c = 100, u = !1, f = 0, h = 0, p = 0, m = !1, g = 0, v = function() {};
            "hide" !== i ? (e(this).hasClass("xdsoft_scroller_box") || (n = l.children().eq(0),
            o = l[0].clientHeight,
            s = n[0].offsetHeight,
            ...
            v = function(e) {
                var t = d(e).y - f + g;
                t < 0 && (t = 0),
                t + a[0].offsetHeight > p && (t = p - a[0].offsetHeight),
            ...
            a.on("touchstart.xdsoft_scroller mousedown.xdsoft_scroller", (function(n) {
                ...
                p = r[0].offsetHeight,
                "mousedown" === n.type || "touchstart" === n.type ? (t.ownerDocument && e(t.ownerDocument.body).addClass("xdsoft_noselect"),
                ...
                e(t.ownerDocument.body).on("mousemove.xdsoft_scroller", v)) : (m = !0,
                n.stopPropagation(),
                n.preventDefault())
            }
            ...
            l.on("mousewheel", (function(e) {
                ...
                l.trigger("scroll_element.xdsoft_scroller", [t / (s - o)]),
                e.stopPropagation(),
                !1
            }
            )),
            l.on("touchstart", (function(e) {
                u = d(e),
                h = Math.abs(parseInt(n.css("marginTop"), 10))
            }
            )),
    ...
    e.fn.datetimepicker = function(n, s) {
        ...
        return r = function(t) {
            ...
            A.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", (function(t) {
                ...
                for (A.find(".xdsoft_select").hide(),
                C.currentTime && (s = C.currentTime[e(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()),
                o[a ? "hide" : "show"](),
                i = o.find("div.xdsoft_option"),
                n = 0; n < i.length && i.eq(n).data("value") !== s; n += 1)
                    r += i[0].offsetHeight;
                return o.xdsoftScroller(S, r / (o.children()[0].offsetHeight - o[0].clientHeight)),
                t.stopPropagation(),
                !1
            }
            ));
            ...
            function $() {
                var e, i = !1;
                return S.startDate ? i = C.strToDate(S.startDate) : (i = S.value || (t && t.val && t.val() ? t.val() : "")) ? (i = C.strToDateTime(i),
                S.yearOffset && (i = new Date(i.getFullYear() - S.yearOffset,i.getMonth(),i.getDate(),i.getHours(),i.getMinutes(),i.getSeconds(),i.getMilliseconds()))) : S.defaultDate && (i = C.strToDateTime(S.defaultDate),
                S.defaultTime && (e = C.strtotime(S.defaultTime),
            ...
            function H(n) {
                var o = function(e, t) {
                  ...
                  , s = function(e, t) {
                    if (!(e = "string" == typeof e || e instanceof String ? n.ownerDocument.getElementById(e) : e))
                        return !1;
                ...
                !0 === n.mask && (i.formatMask ? n.mask = i.formatMask(n.format) : n.mask = n.format.replace(/Y/g, "9999").replace(/F/g, "9999").replace(/m/g, "19").replace(/d/g, "39").replace(/H/g, "29").replace(/i/g, "59").replace(/s/g, "59")),
                "string" === e.type(n.mask) && (o(n.mask, t.val()) || (t.val(n.mask.replace(/[0-9]/g, "_")),
                s(t[0], 0)),
                t.on("paste.xdsoft", (function(i) {
                    ...
                    return a = a.substr(0, l) + r + a.substr(l + r.length),
                    l += r.length,
                    o(n.mask, a) ? (this.value = a,
                    s(this, l)) : "" === e.trim(a) ? this.value = n.mask.replace(/[0-9]/g, "_") : t.trigger("error_input.xdsoft"),
                    i.preventDefault(),
                    !1
                }
                )),
                t.on("keydown.xdsoft", (function(i) {
                    var r, a = this.value, l = i.which, c = this.selectionStart, S = this.selectionEnd, C = c !== S;
                    if (48 <= l && l <= 57 || 96 <= l && l <= 105 || 8 === l || 46 === l) {
                        for (r = 8 === l || 46 === l ? "_" : String.fromCharCode(96 <= l && l <= 105 ? l - 48 : l),
                        8 === l && c && !C && (c -= 1); ; ) {
                        ...
                        C) {
                            ...
                            a = a.substr(0, c) + r + a.substr(c + 1);
                        if ("" === e.trim(a))
                            a = A;
                        else if (c === n.mask.length)
                            return i.preventDefault(),
                            !1;
                        for (c += 8 === l ? 0 : 1; /[^0-9_]/.test(n.mask.substr(c, 1)) && c < n.mask.length && 0 < c; )
                            c += 8 === l ? 0 : 1;
                        o(n.mask, a) ? (this.value = a,
                        s(this, c)) : "" === e.trim(a) ? this.value = n.mask.replace(/[0-9]/g, "_") : t.trigger("error_input.xdsoft")
                    } else if (-1 !== [b, _, w, x, k].indexOf(l) && T || -1 !== [f, p, g, h, m, y, d, v, u].indexOf(l))
                        return !0;
                    return i.preventDefault(),
                    !1
                }
            ...
            A.find(".xdsoft_select").xdsoftScroller(S).on("touchstart mousedown.xdsoft", (function(e) {
                var t = e.originalEvent;
                this.touchMoved = !1,
            ...
            D.setOptions = function(n) {
                ...
                n.highlightedDates && e.isArray(n.highlightedDates) && n.highlightedDates.length && (e.each(n.highlightedDates, (function(t, n) {
                    var s, r = e.map(n.split(","), e.trim), a = new c(i.parseDate(r[0], S.formatDate),r[1],r[2]), l = i.formatDate(a.date, S.formatDate);
                    void 0 !== o[l] ? (s = o[l].desc) && s.length && a.desc && a.desc.length && (o[l].desc = s + "\n" + a.desc) : o[l] = a
                }
                )),
                S.highlightedDates = e.extend(!0, [], o)),
                n.highlightedPeriods && e.isArray(n.highlightedPeriods) && n.highlightedPeriods.length && (o = e.extend(!0, [], S.highlightedDates),
                e.each(n.highlightedPeriods, (function(t, n) {
                    ...
                    if (e.isArray(n))
                        ...
                        s = i.parseDate(h[0], S.formatDate),
                        r = i.parseDate(h[1], S.formatDate),
                        a = h[2],
                        f = h[3]
                    }
                    for (; s <= r; )
                ...
                S.validateOnBlur && t.off("blur.xdsoft").on("blur.xdsoft", (function() {
                    if (S.allowBlank && (!e.trim(e(this).val()).length || "string" == typeof S.mask && e.trim(e(this).val()) === S.mask.replace(/[0-9]/g, "_")))
                        e(this).val(null),
                        D.data("xdsoft_datetime").empty();
                    else {
                        var t = i.parseDate(e(this).val(), S.format);
                        if (t)
                            e(this).val(i.formatDate(t, S.format));
                        else {
            ...
            C = new function() {
                ...
                t.now = function(e) {
                    var i, n, o = new Date;
                    return !e && S.defaultDate && (i = t.strToDateTime(S.defaultDate),
                    o.setFullYear(i.getFullYear()),
                    o.setMonth(i.getMonth()),
                    o.setDate(i.getDate())),
                    o.setFullYear(o.getFullYear()),
                    !e && S.defaultTime && (n = t.strtotime(S.defaultTime),
                    o.setHours(n.getHours()),
                    o.setMinutes(n.getMinutes()),
                    o.setSeconds(n.getSeconds()),
                    o.setMilliseconds(n.getMilliseconds())),
                    o
                }
                ,
                ...
                t.getWeekOfYear = function(t) {
                    ...
                    return 4 !== n.getDay() && n.setMonth(0, 1 + (4 - n.getDay() + 7) % 7),
                    Math.ceil(((t - n) / 864e5 + n.getDay() + 1) / 7)
                }
                ,
                t.strToDateTime = function(e) {
                    var n, o, s = [];
                    return e && e instanceof Date && t.isValidDate(e) ? e : ((s = /^([+-]{1})(.*)$/.exec(e)) && (s[2] = i.parseDate(s[2], S.formatDate)),
                    o = s && s[2] ? (n = s[2].getTime() - 6e4 * s[2].getTimezoneOffset(),
                    new Date(t.now(!0).getTime() + parseInt(s[1] + "1", 10) * n)) : e ? i.parseDate(e, S.format) : t.now(),
                ...
                t.strToDate = function(e) {
                    ...
                    return t.isValidDate(n) || (n = t.now(!0)),
                    n
                }
                ,
                ...
                t.str = function() {
                    var e = S.format;
                    return S.yearOffset && (e = (e = e.replace("Y", t.currentTime.getFullYear() + S.yearOffset)).replace("y", String(t.currentTime.getFullYear() + S.yearOffset).substring(2, 4))),
            ...
            A.find(".xdsoft_today_button").on("touchend mousedown.xdsoft", (function() {
                ...
                n < (e = new Date(e.getFullYear(),e.getMonth(),e.getDate())) || (i = C.strToDate(S.maxDate),
                (i = new Date(i.getFullYear(),i.getMonth(),i.getDate())) < n || (t.val(C.str()),
                t.trigger("change"),
                D.trigger("close.xdsoft")))
            }
            )),
            A.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", (function() {
                var t = e(this)
                  ...
                  , n = !1;
                !function e(o) {
                    t.hasClass(S.next) ? C.nextMonth() : t.hasClass(S.prev) && C.prevMonth(),
                    S.monthChangeSpinner && (n || (i = setTimeout(e, o || 100)))
                }(500),
                e([S.ownerDocument.body, S.contentWindow]).on("touchend mouseup.xdsoft", (function t() {
                    clearTimeout(i),
                    n = !0,
                    e([S.ownerDocument.body, S.contentWindow]).off("touchend mouseup.xdsoft", t)
                }
                ))
            }
            )),
            M.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", (function() {
                ...
                !function e(s) {
                    ...
                    t.hasClass(S.next) && a - r - S.timeHeightInTimePicker >= l ? I.css("marginTop", "-" + (l + S.timeHeightInTimePicker) + "px") : t.hasClass(S.prev) && 0 <= l - S.timeHeightInTimePicker && I.css("marginTop", "-" + (l - S.timeHeightInTimePicker) + "px"),
            ...
            D.on("xchange.xdsoft", (function(r) {
                ...
                s = setTimeout((function() {
                    void 0 !== C.currentTime && null !== C.currentTime || (C.currentTime = C.now());
                    for (var s, r, a, l, d, c, u, f, h, p, m = "", g = new Date(C.currentTime.getFullYear(),C.currentTime.getMonth(),1,12,0,0), v = 0, y = C.now(), b = !1, _ = !1, w = !1, x = !1, k = [], T = !0, O = ""; g.getDay() !== S.dayOfWeekStart; )
                        g.setDate(g.getDate() - 1);
                    for (m += "<table><thead><tr>",
                    S.weeks && (m += "<th></th>"),
                    s = 0; s < 7; s += 1)
                        m += "<th>" + S.i18n[o].dayOfWeekShort[(s + S.dayOfWeekStart) % 7] + "</th>";
                    for (m += "</tr></thead>",
                    m += "<tbody>",
                    !1 !== S.maxDate && (b = C.strToDate(S.maxDate),
                    b = new Date(b.getFullYear(),b.getMonth(),b.getDate(),23,59,59,999)),
                    !1 !== S.minDate && (_ = C.strToDate(S.minDate),
                    _ = new Date(_.getFullYear(),_.getMonth(),_.getDate())),
                    !1 !== S.minDateTime && (w = C.strToDate(S.minDateTime),
                    w = new Date(w.getFullYear(),w.getMonth(),w.getDate(),w.getHours(),w.getMinutes(),w.getSeconds())),
                    !1 !== S.maxDateTime && (x = C.strToDate(S.maxDateTime),
                    x = new Date(x.getFullYear(),x.getMonth(),x.getDate(),x.getHours(),x.getMinutes(),x.getSeconds())),
                    !1 !== x && (p = 31 * (12 * x.getFullYear() + x.getMonth()) + x.getDate()); v < C.currentTime.countDaysInMonth() || g.getDay() !== S.dayOfWeekStart || C.currentTime.getMonth() === g.getMonth(); ) {
                        k = [],
                        v += 1,
                        a = g.getDay(),
                        l = g.getDate(),
                        ...
                        void 0 !== S.highlightedDates[i.formatDate(g, S.formatDate)] && (r = S.highlightedDates[i.formatDate(g, S.formatDate)],
                        k.push(void 0 === r.style ? "xdsoft_highlighted_default" : r.style),
                        h = void 0 === r.desc ? "" : r.desc),
                        S.beforeShowDay && e.isFunction(S.beforeShowDay) && k.push(S.beforeShowDay(g)),
                        T && (m += "<tr>",
                        T = !1,
                        S.weeks && (m += "<th>" + c + "</th>")),
                        m += '<td data-date="' + l + '" data-month="' + L + '" data-year="' + d + '" class="xdsoft_date xdsoft_day_of_week' + g.getDay() + " " + k.join(" ") + '" title="' + h + '"><div>' + l + "</div></td>",
                        g.getDay() === S.dayOfWeekStartPrev && (m += "</tr>",
                        T = !0),
                        g.setDate(l + 1)
                    }
                    m += "</tbody></table>",
                    ...
                    A.find(".xdsoft_label span").eq(1).text(C.currentTime.getFullYear() + S.yearOffset),
                    L = O = "";
                    var P = 0;
                    if (!1 !== S.minTime) {
                    ...
                    var z = 1440;
                    if (!1 !== S.maxTime && (M = C.strtotime(S.maxTime),
                    z = 60 * M.getHours() + M.getMinutes()),
                    !1 !== S.minDateTime && (M = C.strToDateTime(S.minDateTime),
                    i.formatDate(C.currentTime, S.formatDate) === i.formatDate(M, S.formatDate))) {
                        var L = 60 * M.getHours() + M.getMinutes();
                        P < L && (P = L)
                    }
                    if (!1 !== S.maxDateTime && (M = C.strToDateTime(S.maxDateTime),
                    i.formatDate(C.currentTime, S.formatDate) === i.formatDate(M, S.formatDate) && (L = 60 * M.getHours() + M.getMinutes()) < z && (z = L)),
                    f = function(n, o) {
                        var s, r = C.now(), a = S.allowTimes && e.isArray(S.allowTimes) && S.allowTimes.length;
                        r.setHours(n),
                        n = parseInt(r.getHours(), 10),
                        r.setMinutes(o),
                        o = parseInt(r.getMinutes(), 10),
                        k = [];
                        var l = 60 * n + o;
                        ...
                        (S.initTime || S.defaultSelect || D.data("changed")) && s.getHours() === parseInt(n, 10) && (!a && 59 < S.step || s.getMinutes() === parseInt(o, 10)) && (S.defaultSelect || D.data("changed") ? k.push("xdsoft_current") : S.initTime && k.push("xdsoft_init_time")),
                    ...
                    S.allowTimes && e.isArray(S.allowTimes) && S.allowTimes.length)
                        for (v = 0; v < S.allowTimes.length; v += 1)
                            f(C.strtotime(S.allowTimes[v]).getHours(), L = C.strtotime(S.allowTimes[v]).getMinutes());
                    else
                ...
                var e, t, i, n;
                S.timepicker && (I.find(".xdsoft_current").length ? e = ".xdsoft_current" : I.find(".xdsoft_init_time").length && (e = ".xdsoft_init_time"),
                e ? (t = z[0].clientHeight,
                (i = I[0].offsetHeight) - t < (n = I.find(e).index() * S.timeHeightInTimePicker + 1) && (n = i - t),
                z.trigger("scroll_element.xdsoft_scroller", [parseInt(n, 10) / (i - t)])) : z.trigger("scroll_element.xdsoft_scroller", [0]))
            }
            )),
            r = 0,
            ...
            P.on("mousewheel.xdsoft", (function(e) {
                return !S.scrollMonth || (e.deltaY < 0 ? C.nextMonth() : C.prevMonth(),
                !1)
            }
            )),
            t.on("mousewheel.xdsoft", (function(e) {
                return !S.scrollInput || (!S.datepicker && S.timepicker ? (0 <= (a = I.find(".xdsoft_current").length ? I.find(".xdsoft_current").eq(0).index() : 0) + e.deltaY && a + e.deltaY < I.children().length && (a += e.deltaY),
                I.children().eq(a).length && I.children().eq(a).trigger("mousedown"),
                !1) : S.datepicker && !S.timepicker ? (P.trigger(e, [e.deltaY, e.deltaX, e.deltaY]),
                t.val && t.val(C.str()),
                D.trigger("changedatetime.xdsoft"),
                !1) : void 0)
            }
            ...
            D.on("changedatetime.xdsoft", (function(t) {
                if (S.onChangeDateTime && e.isFunction(S.onChangeDateTime)) {
                    var i = D.data("input");
                    S.onChangeDateTime.call(D, C.currentTime, i, t),
                    delete S.value,
                    i.trigger("change")
                }
            }
            )).on("generate.xdsoft", (function() {
                S.onGenerate && e.isFunction(S.onGenerate) && S.onGenerate.call(D, C.currentTime, D.data("input")),
                R && (D.trigger("afterOpen.xdsoft"),
                R = !1)
            }
            ...
            l = function() {
                ...
                S.fixed ? (n -= h,
                o -= e(S.contentWindow).scrollLeft(),
                s = "fixed") : (a = !1,
                O(i, (function(e) {
                    return null !== e && ("fixed" === S.contentWindow.getComputedStyle(e).getPropertyValue("position") ? !(a = !0) : void 0)
                }
                )),
                a && !S.insideParent ? (s = "fixed",
                n + D.outerHeight() > f + h ? (c = "bottom",
                n = f + h - t.top) : n -= h) : n + D[0].offsetHeight > f + h && (n = t.top - D[0].offsetHeight + 1),
                n < 0 && (n = 0),
                o + i.offsetWidth > d && (o = d - i.offsetWidth)),
                r = D[0],
                O(r, (function(e) {
                    if ("relative" === S.contentWindow.getComputedStyle(e).getPropertyValue("position") && d >= e.offsetWidth)
                        return o -= (d - e.offsetWidth) / 2,
                        !1
                }
                )),
                u = {
            ...
            D.on("open.xdsoft", (function(t) {
                ...
                S.closeOnWithoutClick && e([S.ownerDocument.body, S.contentWindow]).on("touchstart mousedown.xdsoft", (function t() {
                    D.trigger("close.xdsoft"),
                    e([S.ownerDocument.body, S.contentWindow]).off("touchstart mousedown.xdsoft", t)
                }
                )))
            }
            ...
            D.setOptions(S),
            C.setCurrentTime($()),
            t.data("xdsoft_datetimepicker", D).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", (function() {
                t.is(":disabled") || t.data("xdsoft_datetimepicker").is(":visible") && S.closeOnInputClick || S.openOnFocus && (clearTimeout(B),
                B = setTimeout((function() {
                    t.is(":disabled") || (R = !0,
                    C.setCurrentTime($(), !0),
                    S.mask && H(S),
                    D.trigger("open.xdsoft"))
                }
                ), 100))
            }
            )).on("keydown.xdsoft", (function(t) {
                var i, n = t.which;
                return -1 !== [u].indexOf(n) && S.enterLikeTab ? (i = e("input:visible,textarea:visible,button:visible,a:visible"),
                D.trigger("close.xdsoft"),
                i.eq(i.index(this) + 1).focus(),
                !1) : -1 !== [v].indexOf(n) ? (D.trigger("close.xdsoft"),
                !0) : void 0
            }
        ...
        this.each((function() {
            ...
            if (o) {
                if ("string" === e.type(n))
                    ...
                    case "reset":
                        ...
                        this.value && o.data("xdsoft_datetime").isValidDate(i.parseDate(this.value, S.format)) || o.data("changed", !1),
            ...
            "string" !== e.type(n) && (!S.lazyInit || S.open || S.inline ? r(e(this)) : (t = e(this)).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", (function e() {
                t.is(":disabled") || t.data("xdsoft_datetimepicker") || (clearTimeout(C),
                C = setTimeout((function() {
                    t.data("xdsoft_datetimepicker") || r(t),
...
function(e) {
    ...
    var t, i, n = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"], o = "onwheel"in document || 9 <= document.documentMode ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], s = Array.prototype.slice;
    if (e.event.fixHooks)
    ...
    function l(n) {
        var o, r = n || window.event, l = s.call(arguments, 1), u = 0, f = 0, h = 0, p = 0, m = 0;
        if ((n = e.event.fix(r)).type = "mousewheel",
        ...
        0 !== h || 0 !== f) {
            ...
            if (o = Math.max(Math.abs(h), Math.abs(f)),
            (!i || o < i) && c(r, i = o) && (i /= 40),
            c(r, o) && (u /= 40,
            f /= 40,
            h /= 40),
...
function(e) {
    ...
    var t, i, n, o, s, r, a = "Close", l = "BeforeClose", d = "MarkupParse", c = "Open", u = "Change", f = "mfp", h = ".mfp", p = "mfp-ready", m = "mfp-removing", g = "mfp-prevent-close", v = function() {}, y = !!window.jQuery, b = e(window), _ = function(e, i) {
        t.ev.on(f + e + h, i)
    }, w = function(t, i, n, o) {
        var s = document.createElement("div");
        return s.className = "mfp-" + t,
        n && (s.innerHTML = n),
        o ? i && i.appendChild(s) : (s = e(s),
        i && s.appendTo(i)),
        s
    }, x = function(i, n) {
    ...
    v.prototype = {
        ...
        open: function(i) {
            ...
            if (!t.isOpen) {
                ...
                s += " mfp-close-btn-in") : t.wrap.append(k())),
    ...
    ;
    var S, C, O, D = "inline", j = function() {
        O && (C.after(O.addClass(S)).detach(),
        O = null)
    };
            ...
            getInline: function(i, n) {
                ...
                i.src) {
                    ...
                    if (s.length) {
                        ...
                        r && r.tagName && (C || (S = o.hiddenClass,
                        C = w(S),
                        S = "mfp-" + S),
                        O = s.after(C).detach().removeClass(S)),
                ...
                var i = 0
                  ...
                  , o = function(s) {
                    ...
                    z = setInterval((function() {
                        return n.naturalWidth > 0 ? void t._onImageHasSize(e) : (i > 200 && clearInterval(z),
        ...
        proto: {
            initZoom: function() {
                ...
                if (i.enabled && t.supportsTransition) {
                    var o, s, r = i.duration, d = function(e) {
        ...
        proto: {
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var e = t.st.retina
                      , i = e.ratio;
                    (i = isNaN(i) ? i() : i) > 1 && (_("ImageHasSize." + q, (function(e, t) {
                        t.img.css({
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push((function() {
    ...
    function h(e, t, i, n, a) {
        var l, d, c, u, h, p, m, g, v, y, b, _, w, x = e.length - 1, k = 0, T = e[0].a;
        for (l = 0; l < x; l++)
            d = (h = e[k]).a,
            c = h.d,
            u = e[k + 1].d,
            g = a ? (b = o[l],
            w = ((_ = s[l]) + b) * t * .25 / (n ? .5 : r[l] || .5),
            c - ((p = c - (c - d) * (n ? .5 * t : 0 !== b ? w / b : 0)) + (((m = c + (u - c) * (n ? .5 * t : 0 !== _ ? w / _ : 0)) - p) * (3 * b / (b + _) + .5) / 4 || 0))) : c - ((p = c - (c - d) * t * .5) + (m = c + (u - c) * t * .5)) / 2,
            p += g,
            m += g,
            h.c = v = p,
            h.b = 0 !== l ? T : T = h.a + .6 * (h.c - h.a),
            h.da = c - d,
            h.ca = v - d,
            h.ba = T - d,
            i ? (y = f(d, T, v, c),
    ...
    function p(e, t, i, n) {
        ...
        if (n)
            for (a = (e = [n].concat(e)).length; -1 < --a; )
                "string" == typeof (f = e[a][t]) && "=" === f.charAt(1) && (e[a][t] = n[t] + Number(f.charAt(0) + f.substr(2)));
        if ((r = e.length - 2) < 0)
            return h[0] = new u(e[0][t],0,0,e[0][t]),
            h;
        for (a = 0; a < r; a++)
            l = e[a][t],
            d = e[a + 1][t],
            ...
            o[a] = (o[a] || 0) + (d - l) * (d - l),
            s[a] = (s[a] || 0) + (c - d) * (c - d));
        return h[a] = new u(e[a][t],0,0,e[a + 1][t]),
        h
    }
    function m(e, t, i, n, l, d) {
        var c, u, f, m, g, v, y, b, _ = {}, w = [], x = d || e[0];
        ...
        for (o.length = s.length = r.length = 0,
        c = w.length; -1 < --c; )
            u = w[c],
            a[u] = -1 !== l.indexOf("," + u + ","),
            _[u] = p(e, u, a[u], d);
        ...
        if (!n) {
            for (c = w.length; -1 < --c; )
                if (a[u])
                    for (v = (f = _[w[c]]).length - 1,
                    m = 0; m < v; m++)
                        g = f[m + 1].da / s[m] + f[m].da / o[m] || 0,
                        r[m] = (r[m] || 0) + g * g;
            for (c = r.length; -1 < --c; )
                r[c] = Math.sqrt(r[c])
        }
    ...
    function g(e, t, i) {
        for (var n, o, s, r, a, l, d, c, u, f, h, p = 1 / i, m = e.length; -1 < --m; )
            ...
            n = o = 0,
            c = 1; c <= i; c++)
                n = o - (o = ((d = p * c) * d * r + 3 * (u = 1 - d) * (d * a + u * l)) * d),
                t[h = m * i + c - 1] = (t[h] || 0) + n * n
    }
    _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], (function(e, t, i) {
        ...
        function s(e) {
            ...
            return function(e, d, c) {
                var u, f, h, p, m, g, v, y, b, _ = (c || t).length, w = s[_];
                if (!w) {
                    ...
                    for (w = s[_] = [],
                    u = r ? Math.min(b, _) * l - .5 : n % b,
                    f = r ? _ * l / b - .5 : n / b | 0,
                    y = 1 / (v = 0),
                    g = 0; g < _; g++)
                        h = g % b - u,
                        p = f - (g / b | 0),
                        w[g] = m = a ? Math.abs("y" === a ? p : h) : Math.sqrt(h * h + p * p),
                        v < m && (v = m),
                        m < y && (y = m);
                    w.max = v - y,
                    w.min = y,
                    w.v = _ = t.amount || t.each * (_ < b ? _ - 1 : a ? "y" === a ? _ / b : b : Math.max(b, _ / b)) || 0,
                    w.b = _ < 0 ? o - _ : o
                }
                return _ = (w[e] - w.min) / w.max,
                w.b + (i ? i.getRatio(_) : _) * w.v
            }
        }
        ...
        u.updateTo = function(e, t) {
            var n, o = this, s = o.ratio, r = o.vars.immediateRender || e.immediateRender;
            for (n in t && o._startTime < o._timeline._time && (o._startTime = o._timeline._time,
            o._uncache(!1),
            o._gc ? o._enabled(!0, !1) : o._timeline.insert(o, o._startTime - o._delay)),
            e)
                o.vars[n] = e[n];
            if (o._initted || r)
                if (t)
                    o._initted = !1,
                    r && o.render(0, !0, !0);
                else if (o._gc && o._enabled(!0, !1),
                o._notifyPluginsOfEnabled && o._firstPT && i._onPluginEvent("_onDisable", o),
                .998 < o._time / o._duration) {
                    var a = o._totalTime;
                    o.render(0, !0, !1),
                    o._initted = !1,
                    o.render(a, !0, !1)
                } else if (o._initted = !1,
                o._init(),
                0 < o._time || r)
                    for (var l, d = 1 / (1 - s), c = o._firstPT; c; )
                        l = c.s + c.c,
                        c.c *= d,
                        c.s = l - c.c,
                        c = c._next;
        ...
        u.render = function(e, t, n) {
            ...
            var o, s, r, d, c, u, f, h, p, m = this, g = m._dirty ? m.totalDuration() : m._totalDuration, v = m._time, y = m._totalTime, b = m._cycle, _ = m._duration, w = m._rawPrevTime;
            if (g - a <= e && 0 <= e ? (m._totalTime = g,
            m._cycle = m._repeat,
            ...
            (w < 0 || e <= 0 && -a <= e || w === a && "isPause" !== m.data) && w !== e && (n = !0,
            a < w && (s = "onReverseComplete")),
            m._rawPrevTime = h = !t || e || w === e ? e : a)) : e < a ? (m._totalTime = m._time = m._cycle = 0,
            m.ratio = m._ease._calcEnd ? m._ease.getRatio(0) : 0,
            (0 !== y || 0 === _ && 0 < w) && (s = "onReverseComplete",
            o = m._reversed),
            -a < e ? e = 0 : e < 0 && (m._active = !1,
            0 !== _ || !m._initted && m.vars.lazy && !n || (0 <= w && (n = !0),
            m._rawPrevTime = h = !t || e || w === e ? e : a)),
            m._initted || (n = !0)) : (m._totalTime = m._time = e,
            0 !== m._repeat && (d = _ + m._repeatDelay,
            ...
            m._easeType && !p ? (c = m._time / _,
            (1 === (u = m._easeType) || 3 === u && .5 <= c) && (c = 1 - c),
            3 === u && (c *= 2),
            1 === (f = m._easePower) ? c *= c : 2 === f ? c *= c * c : 3 === f ? c *= c * c * c : 4 === f && (c *= c * c * c * c),
            m.ratio = 1 === u ? 1 - c : 2 === u ? c : m._time / _ < .5 ? c / 2 : 1 - c / 2) : p || (m.ratio = m._ease.getRatio(m._time / _))),
            v !== m._time || n || b !== m._cycle) {
                ...
                0 === y && (2 === m._initted && 0 < e && m._init(),
                m._startAt && (0 <= e ? m._startAt.render(e, !0, n) : s = s || "_dummyGS"),
                !m.vars.onStart || 0 === m._totalTime && 0 !== _ || t || m._callback("onStart")),
                r = m._firstPT; r; )
                    r.f ? r.t[r.p](r.c * m.ratio + r.s) : r.t[r.p] = r.c * m.ratio + r.s,
                    r = r._next;
                m._onUpdate && (e < 0 && m._startAt && m._startTime && m._startAt.render(e, !0, n),
                t || m._totalTime === y && !s || m._callback("onUpdate")),
                m._cycle !== b && (t || m._gc || m.vars.onRepeat && m._callback("onRepeat")),
                !s || m._gc && !n || (e < 0 && m._startAt && !m._onUpdate && m._startTime && m._startAt.render(e, !0, n),
                o && (m._timeline.autoRemoveChildren && m._enabled(!1, !1),
                m._active = !1),
        ...
        r.staggerTo = r.allTo = function(e, t, a, l, u, h, p) {
            var m, g, v, y, b = [], _ = s(a.stagger || l), w = a.cycle, x = (a.startAt || f).cycle;
        ...
        var h = function(e, t) {
            for (var n = [], o = 0, s = e._first; s; )
                s instanceof i ? n[o++] = s : (t && (n[o++] = s),
                o = (n = n.concat(h(s, t))).length),
                s = s._next;
            return n
        }
        ...
        function m(e, i, n, o) {
            i = !1 !== i,
            n = !1 !== n;
            for (var s, r, a = p(o = !1 !== o), l = i && n && o, d = a.length; -1 < --d; )
                r = a[d],
                (l || r instanceof t || (s = r.target === r.vars.onComplete) && n || i && !s) && r.paused(e)
        }
        return r.killAll = function(e, i, n, o) {
            null == i && (i = !0),
            null == n && (n = !0);
            var s, r, a, l = p(0 != o), d = l.length, c = i && n && o;
            for (a = 0; a < d; a++)
                r = l[a],
                (c || r instanceof t || (s = r.target === r.vars.onComplete) && n || i && !s) && (e ? r.totalTime(r._reversed ? 0 : r.totalDuration()) : r._enabled(!1, !1))
        }
        ,
        r.killChildTweensOf = function(e, t) {
            if (null != e) {
                ...
                c(e))
                    for (u = e.length; -1 < --u; )
                        r.killChildTweensOf(e[u], t);
                else {
                    for (a in o = [],
                    h)
                        for (s = h[a].target.parentNode; s; )
                            s === e && (o = o.concat(h[a].tweens)),
                            s = s.parentNode;
                    for (f = o.length,
                    u = 0; u < f; u++)
        ...
        u.time = function(e, t) {
            ...
            return i < e && (e = i),
            this.totalTime(this._yoyo && 1 & n ? i - e + o : this._repeat ? e + o : e, t)
        }
        ,
    ...
    _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], (function(e, t, i) {
        function n(e) {
            ...
            s)
                i = s[n],
                f(i) && -1 !== i.join("").indexOf("{self}") && (s[n] = o._swapSelfInParams(i));
        ...
        v.staggerTo = function(e, t, r, l, d, c, f, h) {
            ...
            }), v = a(r.stagger || l), y = r.startAt, b = r.cycle;
        ...
        v.staggerFromTo = function(e, t, i, n, o, s, a, l, d) {
            return n.startAt = i,
            this.staggerTo(e, t, r(0, n, i), o, s, a, l, d)
        }
        ,
        ...
        n.exportRoot = function(e, t) {
            ...
            var o, s, r, a, l = new n(e), d = l._timeline;
            for (null == t && (t = !0),
            d._remove(l, !0),
            l._startTime = 0,
            ...
            r = d._first; r; )
                a = r._next,
                t && r instanceof i && r.target === r.vars.onComplete || ((s = r._startTime - r._delay) < 0 && (o = 1),
                l.add(r, s)),
                r = a;
            return d.add(l, 0),
            o && l.totalDuration(),
        ...
        v.add = function(o, s, r, a) {
            ...
            !(o instanceof e)) {
                ...
                if ("string" == typeof o)
                    return m.addLabel(o, s);
                if ("function" != typeof o)
                    throw "Cannot add " + o + " into the timeline; it is not a tween, timeline, function, or string.";
                o = i.delayedCall(0, o)
            }
            if (t.prototype.add.call(m, o, s),
            (o._time || !o._duration && o._initted) && (l = (m.rawTime() - o._startTime) * o._timeScale,
            (!o._duration || 1e-5 < Math.abs(Math.max(0, Math.min(o.totalDuration(), l))) - o._totalTime) && o.render(l, !1, !1)),
            (m._gc || m._time === m._duration) && !m._paused && m._duration < m.duration())
                for (p = (h = m).rawTime() > o._startTime; h._timeline; )
        ...
        v._parseTimeOrLabel = function(t, i, n, o) {
            var s, r;
            if (o instanceof e && o.timeline === this)
                this.remove(o);
            else if (o && (o instanceof Array || o.push && f(o)))
                for (r = o.length; -1 < --r; )
                    o[r]instanceof e && o[r].timeline === this && this.remove(o[r]);
            if (s = "number" != typeof t || i ? 99999999999 < this.duration() ? this.recent().endTime(!1) : this._duration : 0,
            "string" == typeof i)
            ...
            "string" != typeof t || !isNaN(t) && null == this._labels[t])
                ...
                if (-1 === (r = t.indexOf("=")))
                    return null == this._labels[t] ? n ? this._labels[t] = s + i : i : this._labels[t] + i;
                i = parseInt(t.charAt(r - 1) + "1", 10) * Number(t.substr(r + 1)),
                t = 1 < r ? this._parseTimeOrLabel(t.substr(0, r - 1), 0, n) : s
            }
            return Number(t) + i
        }
        ,
        ...
        v.render = function(e, t, i) {
            ...
            var n, o, s, r, a, d, c, u, f = this, m = f._time, g = f._dirty ? f.totalDuration() : f._totalDuration, v = f._startTime, y = f._timeScale, b = f._paused;
            if (m !== f._time && (e += f._time - m),
            f._hasPause && !f._forcingPlayhead && !t) {
                if (m < e)
                    for (n = f._first; n && n._startTime <= e && !d; )
                        n._duration || "isPause" !== n.data || n.ratio || 0 === n._startTime && 0 === f._rawPrevTime || (d = n),
                        n = n._next;
                else
                    for (n = f._last; n && n._startTime >= e && !d; )
                        n._duration || "isPause" === n.data && 0 < n._rawPrevTime && (d = n),
                        n = n._prev;
                d && (f._time = f._totalTime = e = d._startTime,
                u = f._startTime + (f._reversed ? f._duration - e : e) / f._timeScale)
            }
            if (g - l <= e && 0 <= e)
                f._totalTime = f._time = g,
                f._reversed || f._hasPausedChild() || (o = !0,
                r = "onComplete",
                a = !!f._timeline.autoRemoveChildren,
                0 === f._duration && (e <= 0 && -l <= e || f._rawPrevTime < 0 || f._rawPrevTime === l) && f._rawPrevTime !== e && f._first && (a = !0,
                f._rawPrevTime > l && (r = "onReverseComplete"))),
                f._rawPrevTime = f._duration || !t || e || f._rawPrevTime === e ? e : l,
                e = g + 1e-4;
            else if (e < l)
                if (f._totalTime = f._time = 0,
                -l < e && (e = 0),
                (0 !== m || 0 === f._duration && f._rawPrevTime !== l && (0 < f._rawPrevTime || e < 0 && 0 <= f._rawPrevTime)) && (r = "onReverseComplete",
                o = f._reversed),
                e < 0)
                    f._active = !1,
                    f._timeline.autoRemoveChildren && f._reversed ? (a = o = !0,
                    r = "onReverseComplete") : 0 <= f._rawPrevTime && f._first && (a = !0),
                    f._rawPrevTime = e;
                else {
                    if (f._rawPrevTime = f._duration || !t || e || f._rawPrevTime === e ? e : l,
                    0 === e && o)
                        for (n = f._first; n && 0 === n._startTime; )
                            n._duration || (o = !1),
                            n = n._next;
                    e = 0,
                    f._initted || (a = !0)
            ...
            if (f._time !== m && f._first || i || a || d) {
                ...
                m <= (c = f._time))
                    for (n = f._first; n && (s = n._next,
                    c === f._time && (!f._paused || b)); )
                        (n._active || n._startTime <= c && !n._paused && !n._gc) && (d === n && (f.pause(),
                        f._pauseTime = u),
                        n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (e - n._startTime) * n._timeScale, t, i) : n.render((e - n._startTime) * n._timeScale, t, i)),
                        n = s;
                else
                    for (n = f._last; n && (s = n._prev,
                    c === f._time && (!f._paused || b)); ) {
                        if (n._active || n._startTime <= m && !n._paused && !n._gc) {
                            if (d === n) {
                                for (d = n._prev; d && d.endTime() > f._time; )
                ...
                f._onUpdate && (t || (h.length && p(),
                f._callback("onUpdate"))),
                r && (f._gc || v !== f._startTime && y === f._timeScale || !(0 === f._time || g >= f.totalDuration()) || (o && (h.length && p(),
                f._timeline.autoRemoveChildren && f._enabled(!1, !1),
                f._active = !1),
                !t && f.vars[r] && f._callback(r)))
            }
        }
        ,
        ...
        v.getChildren = function(e, t, n, o) {
            ...
            for (var s = [], r = this._first, a = 0; r; )
                r._startTime < o || (r instanceof i ? !1 !== t && (s[a++] = r) : (!1 !== n && (s[a++] = r),
        ...
        v.getTweensOf = function(e, t) {
            var n, o, s = this._gc, r = [], a = 0;
            for (s && this._enabled(!0, !0),
            o = (n = i.getTweensOf(e)).length; -1 < --o; )
        ...
        v._kill = function(e, t) {
            ...
            for (var i = t ? this.getTweensOf(t) : this.getChildren(!0, !0, !1), n = i.length, o = !1; -1 < --n; )
                i[n]._kill(e, t) && (o = !0);
            return o
        }
        ,
        ...
        v.totalDuration = function(e) {
            ...
            if (this._dirty) {
                for (var t, i, n = 0, o = this, s = o._last, r = 999999999999; s; )
                    ...
                    s._startTime > r && o._sortChildren && !s._paused && !o._calculatingDuration ? (o._calculatingDuration = 1,
                    o.add(s, s._startTime - s._delay),
                    o._calculatingDuration = 0) : r = s._startTime,
                    s._startTime < 0 && !s._paused && (n -= s._startTime,
                    o._timeline.smoothChildTiming && (o._startTime += s._startTime / o._timeScale,
                    ...
                    s = t;
                o._duration = o._totalDuration = n,
                o._dirty = !1
            }
    ...
    _gsScope._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], (function(e, t, i) {
        ...
        c.removeCallback = function(e, t) {
            if (e)
                if (null == t)
                    ...
                    for (var i = this.getTweensOf(e, !1), n = i.length, o = this._parseTimeOrLabel(t); -1 < --n; )
        ...
        c.tweenTo = function(e, i) {
            ...
            for (o in i)
                r[o] = i[o];
            return r.time = this._parseTimeOrLabel(e),
        ...
        c.render = function(e, t, i) {
            this._gc && this._enabled(!0, !1);
            var n, s, l, d, c, u, f, h, p, m = this, g = m._time, v = m._dirty ? m.totalDuration() : m._totalDuration, y = m._duration, b = m._totalTime, _ = m._startTime, w = m._timeScale, x = m._rawPrevTime, k = m._paused, T = m._cycle;
            if (g !== m._time && (e += m._time - g),
            v - o <= e && 0 <= e)
                m._locked || (m._totalTime = v,
                m._cycle = m._repeat),
                m._reversed || m._hasPausedChild() || (s = !0,
                d = "onComplete",
                c = !!m._timeline.autoRemoveChildren,
                0 === m._duration && (e <= 0 && -o <= e || x < 0 || x === o) && x !== e && m._first && (c = !0,
                o < x && (d = "onReverseComplete"))),
                ...
                m._time = 0,
                -o < e && (e = 0),
                (0 !== g || 0 === y && x !== o && (0 < x || e < 0 && 0 <= x) && !m._locked) && (d = "onReverseComplete",
                s = m._reversed),
                e < 0)
                    m._active = !1,
                    m._timeline.autoRemoveChildren && m._reversed ? (c = s = !0,
                    d = "onReverseComplete") : 0 <= x && m._first && (c = !0),
                    m._rawPrevTime = e;
                else {
                    if (m._rawPrevTime = y || !t || e || m._rawPrevTime === e ? e : o,
                    0 === e && s)
                ...
                0 !== m._repeat && (u = y + m._repeatDelay,
            ...
            if (m._hasPause && !m._forcingPlayhead && !t) {
                if (g < (e = m._time) || m._repeat && T !== m._cycle)
                    for (n = m._first; n && n._startTime <= e && !f; )
                        n._duration || "isPause" !== n.data || n.ratio || 0 === n._startTime && 0 === m._rawPrevTime || (f = n),
                        n = n._next;
                else
                    for (n = m._last; n && n._startTime >= e && !f; )
                        n._duration || "isPause" === n.data && 0 < n._rawPrevTime && (f = n),
                        n = n._prev;
                f && (p = m._startTime + (m._reversed ? m._duration - f._startTime : f._startTime) / m._timeScale,
                f._startTime < y && (m._time = m._rawPrevTime = e = f._startTime,
            ...
            if (m._cycle !== T && !m._locked) {
                ...
                g = S ? 0 : y,
                m.render(g, t, 0 === y),
                t || m._gc || m.vars.onRepeat && (m._cycle = D,
                m._locked = !1,
            ...
            if (m._time !== g && m._first || i || c || f) {
                ...
                g <= (h = m._time))
                    ...
                    h === m._time && (!m._paused || k)); )
                        (n._active || n._startTime <= m._time && !n._paused && !n._gc) && (f === n && (m.pause(),
                        m._pauseTime = p),
                        n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (e - n._startTime) * n._timeScale, t, i) : n.render((e - n._startTime) * n._timeScale, t, i)),
                        n = l;
                else
                    ...
                    h === m._time && (!m._paused || k)); ) {
                        if (n._active || n._startTime <= g && !n._paused && !n._gc) {
                            if (f === n) {
                                for (f = n._prev; f && f.endTime() > m._time; )
                ...
                m._onUpdate && (t || (r.length && a(),
                m._callback("onUpdate"))),
                d && (m._locked || m._gc || _ !== m._startTime && w === m._timeScale || !(0 === m._time || v >= m.totalDuration()) || (s && (r.length && a(),
                m._timeline.autoRemoveChildren && m._enabled(!1, !1),
                m._active = !1),
                !t && m.vars[d] && m._callback(d)))
            } else
                b !== m._totalTime && m._onUpdate && (t || m._callback("onUpdate"))
        }
        ,
        c.getActive = function(e, t, i) {
            var n, o, s = [], r = this.getChildren(e || null == e, t || null == e, !!i), a = 0, l = r.length;
            for (n = 0; n < l; n++)
                (o = r[n]).isActive() && (s[a++] = o);
            return s
        }
        ,
    ...
    d = _gsScope._gsDefine.plugin({
        ...
        init: function(e, t, i) {
            ...
            var n, o, s, r, a, l = t.values || [], d = {}, c = l[0], f = t.autoRotate || i.vars.orientToBezier;
            ...
            for (s = this._props.length; -1 < --s; )
                ...
                a || d[n] !== l[0][n] && (a = d);
            if (this._beziers = "cubic" !== t.type && "quadratic" !== t.type && "soft" !== t.type ? m(l, isNaN(t.curviness) ? 1 : t.curviness, !1, "thruBasic" === t.type, t.correlate, a) : function(e, t, i) {
                var n, o, s, r, a, l, d, c, f, h, p, m = {}, g = "cubic" === (t = t || "soft") ? 3 : 2, v = "soft" === t, y = [];
                if (v && i && (e = [i].concat(e)),
                null == e || e.length < 1 + g)
                ...
                for (l = y.length; -1 < --l; ) {
                    ...
                    d = h = 0; d < c; d += g)
                        ...
                        s = a[d + 2],
                        r = 2 == g ? 0 : a[d + 3],
                        a[h++] = p = 3 == g ? new u(n,o,s,r) : new u(n,(2 * o + n) / 3,(2 * o + s) / 3,s);
                    a.length = h
                }
                return m
            }(l, t.type, d),
            ...
            this._timeRes) {
                var h = function(e, t) {
                    var i, n, o, s, r = [], a = [], l = 0, d = 0, c = (t = t >> 0 || 6) - 1, u = [], f = [];
                    for (i in e)
                        g(e[i], r, t);
                    for (o = r.length,
                    n = 0; n < o; n++)
        ...
        set: function(e) {
            var t, i, o, s, r, a, l, d, c, u, f, h = this._segCount, p = this._func, m = this._target, g = e !== this._startRatio;
            if (this._timeRes) {
                if (c = this._lengths,
                u = this._curSeg,
                f = e * this._length,
            ...
            for (i = 1 - a,
            o = this._props.length; -1 < --o; )
                s = this._props[o],
                l = (a * a * (r = this._beziers[s][t]).da + 3 * i * (a * r.ca + i * r.ba)) * a + r.a,
        ...
        if (e) {
            ...
            t._registerComplexSpecialProp("bezier", {
                parser: function(e, t, s, r, a, l) {
                    ...
                    l = new d;
                    var c, u, f, h = t.values, p = h.length - 1, m = [], g = {};
                    if (p < 0)
                        return a;
                    for (c = 0; c <= p; c++)
                        f = i(e, h[c], r, a, l, p !== c),
                    ...
                    g.autoRotate = null != f.end.left ? [["left", "top", "rotation", c, !1]] : null != f.end.x && [["x", "y", "rotation", c, !1]]),
                    g.autoRotate && (r._transform || r._enableTransforms(!1),
                    f.autoRotate = r._target._gsTransform,
    ...
    _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], (function(e, t) {
        ...
        }, a = _gsScope._gsDefine.globals, l = {}, d = r.prototype = new e("css");
        function c(e, t) {
        ...
        function p(e, t) {
            ...
            n = 5; -1 < --n && void 0 === o[i[n] + e]; )
                ;
            return 0 <= n ? (le = "-" + (de = 3 === n ? "ms" : i[n]).toLowerCase() + "-",
            de + e) : null
        }
        function m(e) {
        ...
        function g(e, t) {
            ...
            if (t = t || m(e))
                if (i = t.length)
                    for (; -1 < --i; )
                        -1 !== (o = t[i]).indexOf("-transform") && Be !== o || (s[o.replace(Y, c)] = t.getPropertyValue(o));
                else
                    for (i in t)
                        -1 !== i.indexOf("Transform") && Re !== i || (s[i] = t[i]);
            else if (t = e.currentStyle || e.style)
                for (i in t)
                    "string" == typeof i && void 0 === s[i] && (s[i.replace(Y, c)] = t[i]);
            return ae || (s.opacity = f(e)),
            n = Ve(e, t, !1),
        ...
        function v(e, t, i, n, o) {
            var s, r, a, l = {}, d = e.style;
            for (r in i)
                "cssText" !== r && "length" !== r && isNaN(r) && (t[r] !== (s = i[r]) || o && o[r]) && -1 === r.indexOf("Origin") && ("number" == typeof s || "string" == typeof s) && (l[r] = "auto" !== s || "left" !== r && "top" !== r ? "" !== s && "auto" !== s && "none" !== s || "string" != typeof t[r] || "" === t[r].replace(F, "") ? s : 0 : he(e, r),
        ...
        function b(e, t) {
            return "function" == typeof e && (e = e(A, P)),
        ...
        function w(e, t, i, n) {
            var o, s, r, a, l;
            return "function" == typeof e && (e = e(A, P)),
            (a = null == e ? t : "number" == typeof e ? e : (o = 360,
            s = e.split("_"),
        ...
        !!M && (M.style.cssText = "top:1px;opacity:.55;",
        /^0.55/.test(M.style.opacity))), le = "", de = "", ce = "undefined" != typeof window ? window : ie.defaultView || {
            getComputedStyle: function() {}
        }, ue = r.getStyle = function(e, t, i, n, o) {
            var s;
            return ae || "opacity" !== t ? (!n && e.style[t] ? s = e.style[t] : (i = i || m(e)) ? s = i[t] || i.getPropertyValue(t) || i.getPropertyValue(t.replace(N, "-$1").toLowerCase()) : e.currentStyle && (s = e.currentStyle[t]),
            null == o || s && "none" !== s && "auto" !== s && "auto auto" !== s ? s : o) : f(e)
        }
        , fe = se.convertToPixels = function(e, i, n, o, s) {
            if ("px" === o || !o && "lineHeight" !== i)
                return n;
            if ("auto" === o || !n)
                return 0;
            var a, l, d, c = U.test(i), u = e, f = ne.style, h = n < 0, p = 1 === n;
            if (h && (n = -n),
            p && (n *= 100),
            "lineHeight" !== i || o)
                if ("%" === o && -1 !== i.indexOf("border"))
                    ...
                    if (f.cssText = "border:0 solid red;position:" + ue(e, "position") + ";line-height:0;",
                    "%" !== o && u.appendChild && "v" !== o.charAt(0) && "rem" !== o)
                        f[c ? "borderLeftWidth" : "borderTopWidth"] = n + o;
                    else {
                        if (u = e.parentNode || ie.body,
                        -1 !== ue(u, "display").indexOf("flex") && (f.position = "absolute"),
                        l = u._gsCache,
                        d = t.ticker.frame,
                        l && c && l.time === d)
                    ...
                    u.removeChild(ne),
                    c && "%" === o && !1 !== r.cacheWidths && ((l = u._gsCache = u._gsCache || {}).time = d,
                    l.width = a / n * 100),
        ...
        , pe = {
            width: ["Left", "Right"],
            height: ["Top", "Bottom"]
        }, me = ["marginLeft", "marginRight", "marginTop", "marginBottom"], ge = function(e, t) {
            if ("contain" === e || "auto" === e || "auto auto" === e)
                return e + " ";
            null != e && "" !== e || (e = "0 0");
            var i, n = e.split(" "), o = -1 !== e.indexOf("left") ? "0%" : -1 !== e.indexOf("right") ? "100%" : n[0], s = -1 !== e.indexOf("top") ? "0%" : -1 !== e.indexOf("bottom") ? "100%" : n[1];
            if (3 < n.length && !t) {
            ...
            if (e)
                if ("number" == typeof e)
                    ...
                    ve[e])
                        ...
                        4 === e.length && (e = "#" + (n = e.charAt(1)) + n + (o = e.charAt(2)) + o + (s = e.charAt(3)) + s),
                        ...
                        t) {
                            ...
                            a = Number(i[1]) / 100,
                            n = 2 * (l = Number(i[2]) / 100) - (o = l <= .5 ? l * (a + 1) : l + a - l * a),
                            3 < i.length && (i[3] = Number(i[3])),
                            i[0] = x(r + 1 / 3, n, o),
                            i[1] = x(r, n, o),
                            i[2] = x(r - 1 / 3, n, o);
                    else
                        i = e.match(z) || ve.transparent;
                    i[0] = Number(i[0]),
                    i[1] = Number(i[1]),
                    i[2] = Number(i[2]),
                    3 < i.length && (i[3] = Number(i[3]))
                ...
                i = ve.black;
            return t && !f && (n = i[0] / 255,
            o = i[1] / 255,
            s = i[2] / 255,
            l = ((d = Math.max(n, o, s)) + (c = Math.min(n, o, s))) / 2,
            d === c ? r = a = 0 : (u = d - c,
            a = .5 < l ? u / (2 - d - c) : u / (d + c),
            r = d === n ? (o - s) / u + (o < s ? 6 : 0) : d === o ? (s - n) / u + 2 : (n - o) / u + 4,
            r *= 60),
            i[0] = r + .5 | 0,
            i[1] = 100 * a + .5 | 0,
            i[2] = 100 * l + .5 | 0),
        ...
        function _e(e, t, i, n) {
            if (null == e)
                ...
                ;
            var o, s = t ? (e.match(be) || [""])[0] : "", r = e.split(s).join("").match(L) || [], a = e.substr(0, e.indexOf(r[0])), l = ")" === e.charAt(e.length - 1) ? ")" : "", d = -1 !== e.indexOf(" ") ? " " : ",", c = r.length, u = 0 < c ? r[0].replace(z, "") : "";
            return c ? o = t ? function(e) {
                var t, f, h, p;
                if ("number" == typeof e)
                    e += u;
                else if (n && J.test(e)) {
                    for (p = e.replace(J, "|").split("|"),
                    h = 0; h < p.length; h++)
                        p[h] = o(p[h]);
                    return p.join(",")
                }
                if (t = (e.match(be) || [s])[0],
                h = (f = e.split(t).join("").match(L) || []).length,
                c > h--)
                    for (; ++h < c; )
                        f[h] = i ? f[(h - 1) / 2 | 0] : r[h];
            ...
            : function(e) {
                ...
                if ("number" == typeof e)
                    ...
                    for (s = e.replace(J, "|").split("|"),
                    f = 0; f < s.length; f++)
                        s[f] = o(s[f]);
                    return s.join(",")
                }
                if (f = (t = e.match("," == d ? L : W) || []).length,
                c > f--)
                    for (; ++f < c; )
                        t[f] = i ? t[(f - 1) / 2 | 0] : r[f];
        ...
        r.colorStringFilter = function(e) {
            var t, i = e[0] + " " + e[1];
            be.test(i) && (t = -1 !== i.indexOf("hsl(") || -1 !== i.indexOf("hsla("),
            e[0] = k(e[0], t),
            e[1] = k(e[1], t)),
            be.lastIndex = 0
        }
        ...
        var ke = (se._setPluginRatio = function(e) {
            ...
            for (var t, i, n, o, s, r = this.data, a = r.proxy, l = r.firstMPT; l; )
                t = a[l.v],
        ...
        function(e, t, i, n, o) {
          ...
          , Te = (se._parseToProxy = function(e, t, i, n, o, s) {
            var r, a, l, d, c, u = n, f = {}, h = {}, p = i._transform, m = ee;
        ...
        se.CSSPropTween = function(e, t, n, o, r, a, l, d, c, u, f) {
          ...
          , Se = r.parseComplex = function(e, t, i, n, o, s, a, l, d, c) {
            ...
            i = n[0],
            n = n[1]);
            var u, f, h, p, m, g, v, y, _, w, x, k, S, C = i.split(", ").join(",").split(" "), O = n.split(", ").join(",").split(" "), D = C.length, j = !1 !== T;
            for (-1 === n.indexOf(",") && -1 === i.indexOf(",") || (O = -1 !== (n + i).indexOf("rgb") || -1 !== (n + i).indexOf("hsl") ? (C = C.join(" ").replace(J, ", ").split(" "),
            O.join(" ").replace(J, ", ").split(" ")) : (C = C.join(" ").split(",").join(", ").split(" "),
            O.join(" ").split(",").join(", ").split(" ")),
            D = C.length),
            D !== O.length && (D = (C = (s || "").split(" ")).length),
            a.plugin = d,
            a.setRatio = c,
            u = be.lastIndex = 0; u < D; u++)
                if (p = C[u],
                m = O[u] + "",
                (y = parseFloat(p)) || 0 === y)
                    a.appendXtra("", y, b(m, y), m.replace(I, ""), j && -1 !== m.indexOf("px") && Math.round, !0);
                else if (o && be.test(p))
                    ...
                    p = ye(p, S),
                    m = ye(m, S),
                    (_ = 6 < p.length + m.length) && !ae && 0 === m[3] ? (a["xs" + a.l] += a.l ? " transparent" : "transparent",
                    a.e = a.e.split(O[u]).join("transparent")) : (ae || (_ = !1),
                    S ? a.appendXtra(w.substr(0, w.indexOf("hsl")) + (_ ? "hsla(" : "hsl("), p[0], b(m[0], p[0]), ",", !1, !0).appendXtra("", p[1], b(m[1], p[1]), "%,", !1).appendXtra("", p[2], b(m[2], p[2]), _ ? "%," : "%" + k, !1) : a.appendXtra(w.substr(0, w.indexOf("rgb")) + (_ ? "rgba(" : "rgb("), p[0], m[0] - p[0], ",", Math.round, !0).appendXtra("", p[1], m[1] - p[1], ",", Math.round).appendXtra("", p[2], m[2] - p[2], _ ? "," : k, Math.round),
                    _ && (p = p.length < 4 ? 1 : p[3],
                    a.appendXtra("", p, (m.length < 4 ? 1 : m[3]) - p, k, !1))),
                    be.lastIndex = 0;
                else if (g = p.match(z)) {
                    if (!(v = m.match(I)) || v.length !== g.length)
                        return a;
                    for (f = h = 0; f < g.length; f++)
                        x = g[f],
                        w = p.indexOf(x, h),
                        a.appendXtra(p.substr(h, w - h), Number(x), b(v[f], x), "", j && "px" === p.substr(w + x.length, 2) && Math.round, 0 === f),
                        h = w + x.length;
                    a["xs" + a.l] += p.substr(h)
                } else
          ...
          , Ce = 9;
        for ((d = Te.prototype).l = d.pr = 0; 0 < --Ce; )
            d["xn" + Ce] = 0,
            d["xs" + Ce] = "";
        function Oe(e, t) {
            t = t || {},
        ...
        d.appendXtra = function(e, t, i, n, o, s) {
            ...
            r.rxp["xn" + a] = o,
            r["xn" + a] = t,
            r.plugin || (r.xfirst = new Te(r,"xn" + a,t,i,r.xfirst || r,0,r.n,o,r.pr),
        ...
        var De = se._registerComplexSpecialProp = function(e, t, i) {
            ...
            var n, o = e.split(","), s = t.defaultValue;
            for (i = i || [s],
            n = 0; n < o.length; n++)
            ...
            if (!l[e]) {
                ...
                De(e, {
                    parser: function(e, i, n, o, s, r, d) {
                        ...
                        l[n].parse(e, i, n, o, s, r, d)) : (h("Error: " + t + " js file not loaded."),
                        s)
                    }
                })
            }
        ...
        ;
        function Pe(e, t, i) {
            var n, o = ie.createElementNS("http://www.w3.org/2000/svg", e), s = /([a-z])([A-Z])/g;
            for (n in i)
        ...
        function Ae(e, t, i, n, o, s) {
            var a, l, d, c, u, f, h, p, m, g, v, y, b, _, w = e._gsTransform, x = Je(e, !0);
            w && (b = w.xOrigin,
            _ = w.yOrigin),
            (!n || (a = n.split(" ")).length < 2) && (0 === (h = e.getBBox()).x && 0 === h.y && h.width + h.height === 0 && (h = {
            ...
            g = x[4],
            v = x[5],
            (y = f * m - h * p) && (l = c * (m / y) + u * (-p / y) + (p * v - m * g) / y,
            d = c * (-h / y) + u * (f / y) - (f * v - h * g) / y,
            c = i.xOrigin = a[0] = l,
            u = i.yOrigin = a[1] = d)),
            w && (s && (i.xOffset = w.xOffset,
            i.yOffset = w.yOffset,
            w = i),
            o || !1 !== o && !1 !== r.defaultSmoothOrigin ? (l = c - b,
            d = u - _,
            w.xOffset += l * x[0] + d * x[2] - l,
            w.yOffset += l * x[1] + d * x[3] - d) : w.xOffset = w.yOffset = 0),
            s || e.setAttribute("data-svg-origin", a.join(" "))
        }
        function Ee(e) {
            var t, i, n = this.data, o = -n.rotation * K, s = o + n.skewX * K, r = 1e5, a = (Math.cos(o) * n.scaleX * r | 0) / r, l = (Math.sin(o) * n.scaleX * r | 0) / r, d = (Math.sin(s) * -n.scaleY * r | 0) / r, c = (Math.cos(s) * n.scaleY * r | 0) / r, u = this.t.style, f = this.t.currentStyle;
            if (f) {
                i = l,
                l = -d,
                d = -i,
                t = f.filter,
                u.filter = "";
                var h, p, m = this.t.offsetWidth, g = this.t.offsetHeight, v = "absolute" !== f.position, y = "progid:DXImageTransform.Microsoft.Matrix(M11=" + a + ", M12=" + l + ", M21=" + d + ", M22=" + c, b = n.x + m * n.xPercent / 100, _ = n.y + g * n.yPercent / 100;
                if (null != n.ox && (b += (h = (n.oxp ? m * n.ox * .01 : n.ox) - m / 2) - (h * a + (p = (n.oyp ? g * n.oy * .01 : n.oy) - g / 2) * l),
                _ += p - (h * d + p * c)),
                ...
                0 !== e && 1 !== e || 1 != a || 0 !== l || 0 !== d || 1 != c || v && -1 === y.indexOf("Dx=0, Dy=0") || B.test(t) && 100 !== parseFloat(RegExp.$1) || -1 === t.indexOf(t.indexOf("Alpha")) && u.removeAttribute("filter"),
                !v) {
                    var w, x, k, T = j < 8 ? 1 : -1;
                    for (h = n.ieOffsetX || 0,
                    p = n.ieOffsetY || 0,
                    ...
                    Ce = 0; Ce < 4; Ce++)
                        k = (i = -1 !== (w = f[x = me[Ce]]).indexOf("px") ? parseFloat(w) : fe(this.t, x, parseFloat(w), w.replace(R, "")) || 0) !== n[x] ? Ce < 2 ? -n.ieOffsetX : -n.ieOffsetY : Ce < 2 ? h - n.ieOffsetX : p - n.ieOffsetY,
        ...
        (d = Oe.prototype).parseComplex = function(e, t, i, n, o, s) {
            ...
            l = i.replace(J, "|").split("|")) : f && (a = [t],
            l = [i])),
            l) {
                for (d = l.length > a.length ? l.length : a.length,
                r = 0; r < d; r++)
                    t = a[r] = a[r] || this.dflt,
                    i = l[r] = l[r] || this.dflt,
                    f && (c = t.indexOf(f)) !== (u = i.indexOf(f)) && (-1 === u ? a[r] = a[r].split(f).join("") : -1 === c && (a[r] += " " + f));
                t = a.join(", "),
                i = l.join(", ")
            }
        ...
        var Me, ze, Ie, Le, We, Fe = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), Re = p("transform"), Be = le + "transform", qe = p("transformOrigin"), $e = null !== p("perspective"), He = se.Transform = function() {
            this.perspective = parseFloat(r.defaultTransformPerspective) || 0,
            this.force3D = !(!1 === r.defaultForce3D || !$e) && (r.defaultForce3D || "auto")
        }
        , Ne = _gsScope.SVGElement, Ye = ie.documentElement || {}, Ge = (We = j || /Android/i.test(re) && !_gsScope.chrome,
        ie.createElementNS && Ye.appendChild && !We && (ze = Pe("svg", Ye),
        Le = (Ie = Pe("rect", ze, {
            width: 100,
            height: 50,
            x: 100
        ...
        Ye.removeChild(ze)),
        We), Ue = function(e) {
            var t, i = u("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), n = this.parentNode, o = this.nextSibling, s = this.style.cssText;
            if (Ye.appendChild(i),
            i.appendChild(this),
        ...
        }, Qe = [1, 0, 0, 1, 0, 0], Je = function(e, t) {
            var i, n, o, s, r, a, l, d = e._gsTransform || new He, c = e.style;
            if (Re ? n = ue(e, Be, null, !0) : e.currentStyle && (n = (n = e.currentStyle.filter.match(X)) && 4 === n.length ? [n[0].substr(4), Number(n[2].substr(4)), Number(n[1].substr(4)), n[3].substr(4), d.x || 0, d.y || 0].join(",") : ""),
            i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n,
            Re && i && !e.offsetParent && e !== Ye && (s = c.display,
            c.display = "block",
            (l = e.parentNode) && e.offsetParent || (r = 1,
            a = e.nextSibling,
            Ye.appendChild(e)),
            ...
            (d.svg || e.getCTM && Xe(e)) && (i && -1 !== (c[Re] + "").indexOf("matrix") && (n = c[Re],
            i = 0),
            o = e.getAttribute("transform"),
            i && o && (n = "matrix(" + (o = e.transform.baseVal.consolidate().matrix).a + "," + o.b + "," + o.c + "," + o.d + "," + o.e + "," + o.f + ")",
            i = 0)),
            i)
                return Qe;
            for (o = (n || "").match(z) || [],
            Ce = o.length; -1 < --Ce; )
                s = Number(o[Ce]),
                o[Ce] = (r = s - (s |= 0)) ? (1e5 * r + (r < 0 ? -.5 : .5) | 0) / 1e5 + s : s;
            ...
            var s, a, l, d, c, u, f = n && e._gsTransform || new He, h = f.scaleX < 0, p = $e && (parseFloat(ue(e, qe, i, !1, "0 0 0").split(" ")[2]) || f.zOrigin) || 0, m = parseFloat(r.defaultTransformPerspective) || 0;
            if (f.svg = !(!e.getCTM || !Xe(e)),
            f.svg && (Ae(e, ue(e, qe, i, !1, "50% 50%") + "", f, e.getAttribute("data-svg-origin")),
            Me = r.useSVGTransformAttr || Ge),
            (s = Je(e)) !== Qe) {
                if (16 === s.length) {
                    var g, v, y, b, _, w = s[0], x = s[1], k = s[2], T = s[3], S = s[4], C = s[5], O = s[6], D = s[7], j = s[8], P = s[9], A = s[10], E = s[12], M = s[13], z = s[14], I = s[11], L = Math.atan2(O, A);
                    f.zOrigin && (E = j * (z = -f.zOrigin) - s[12],
                    M = P * z - s[13],
                    z = A * z + f.zOrigin - s[14]),
                    f.rotationX = L * Z,
                    L && (g = S * (b = Math.cos(-L)) + j * (_ = Math.sin(-L)),
                    v = C * b + P * _,
                    y = O * b + A * _,
                    j = S * -_ + j * b,
                    P = C * -_ + P * b,
                    ...
                    L = Math.atan2(-k, A),
                    f.rotationY = L * Z,
                    L && (v = x * (b = Math.cos(-L)) - P * (_ = Math.sin(-L)),
                    y = k * b - A * _,
                    P = x * _ + P * b,
                    A = k * _ + A * b,
                    I = T * _ + I * b,
                    ...
                    L = Math.atan2(x, w),
                    f.rotation = L * Z,
                    L && (g = w * (b = Math.cos(L)) + x * (_ = Math.sin(L)),
                    v = S * b + C * _,
                    y = j * b + P * _,
                    x = x * b - w * _,
                    C = C * b - S * _,
                    ...
                    L = Math.atan2(S, C),
                    f.scaleX = (1e5 * Math.sqrt(w * w + x * x + k * k) + .5 | 0) / 1e5,
                    f.scaleY = (1e5 * Math.sqrt(C * C + O * O) + .5 | 0) / 1e5,
                    f.scaleZ = (1e5 * Math.sqrt(j * j + P * P + A * A) + .5 | 0) / 1e5,
                    w /= f.scaleX,
                    S /= f.scaleY,
                    x /= f.scaleX,
                    C /= f.scaleY,
                    2e-5 < Math.abs(L) ? (f.skewX = L * Z,
                    S = 0,
                    ...
                    f.y = M,
                    f.z = z,
                    f.svg && (f.x -= f.xOrigin - (f.xOrigin * w - f.yOrigin * S),
                    ...
                    f.rotation = c,
                    f.skewX = u,
                    $e && (f.rotationX = f.rotationY = f.z = 0,
                    f.perspective = m,
                    f.scaleZ = 1),
                    f.svg && (f.x -= f.xOrigin - (f.xOrigin * F + f.yOrigin * B),
                    f.y -= f.yOrigin - (f.xOrigin * R + f.yOrigin * q))
                }
                for (a in 90 < Math.abs(f.skewX) && Math.abs(f.skewX) < 270 && (h ? (f.scaleX *= -1,
        ...
        , Ke = se.set3DTransformRatio = se.setTransformRatio = function(e) {
            var t, i, n, o, s, r, a, l, d, c, u, f, h, p, m, g, v, y, b, _, w, x, k, T = this.data, S = this.t.style, C = T.rotation, D = T.rotationX, j = T.rotationY, P = T.scaleX, A = T.scaleY, E = T.scaleZ, M = T.x, z = T.y, I = T.z, L = T.svg, W = T.perspective, F = T.force3D, R = T.skewY, B = T.skewX;
            if (R && (B += R,
            C += R),
            !((1 !== e && 0 !== e || "auto" !== F || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && F || I || W || j || D || 1 !== E) || Me && L || !$e)
                C || B || L ? (C *= K,
                x = B * K,
                k = 1e5,
                i = Math.cos(C) * P,
                ...
                n = Math.sin(C - x) * -A,
                r = Math.cos(C - x) * A,
                x && "simple" === T.skewType && (t = Math.tan(x - R * K),
                n *= t = Math.sqrt(1 + t * t),
                r *= t,
                R && (t = Math.tan(R * K),
                i *= t = Math.sqrt(1 + t * t),
                s *= t)),
                L && (M += T.xOrigin - (T.xOrigin * i + T.yOrigin * n) + T.xOffset,
                z += T.yOrigin - (T.xOrigin * s + T.yOrigin * r) + T.yOffset,
                Me && (T.xPercent || T.yPercent) && (m = this.t.getBBox(),
                M += .01 * T.xPercent * m.width,
                z += .01 * T.yPercent * m.height),
                M < (m = 1e-6) && -m < M && (M = 0),
                z < m && -m < z && (z = 0)),
                b = (i * k | 0) / k + "," + (s * k | 0) / k + "," + (n * k | 0) / k + "," + (r * k | 0) / k + "," + M + "," + z + ")",
                L && Me ? this.t.setAttribute("transform", "matrix(" + b) : S[Re] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix(" : "matrix(") + b) : S[Re] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix(" : "matrix(") + P + ",0,0," + A + "," + M + "," + z + ")";
            else {
                if (O && (P < (m = 1e-4) && -m < P && (P = E = 2e-5),
                A < m && -m < A && (A = E = 2e-5),
                !W || T.z || T.rotationX || T.rotationY || (W = 0)),
                C || B)
                    C *= K,
                    g = i = Math.cos(C),
                    v = s = Math.sin(C),
                    ...
                    g = Math.cos(C),
                    v = Math.sin(C),
                    "simple" === T.skewType && (t = Math.tan((B - R) * K),
                    g *= t = Math.sqrt(1 + t * t),
                    v *= t,
                    T.skewY && (t = Math.tan(R * K),
                    i *= t = Math.sqrt(1 + t * t),
                    s *= t))),
                    n = -v,
                    r = g;
                    ...
                    if (!(j || D || 1 !== E || W || L))
                        return void (S[Re] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) translate3d(" : "translate3d(") + M + "px," + z + "px," + I + "px)" + (1 !== P || 1 !== A ? " scale(" + P + "," + A + ")" : ""));
                    i = r = 1,
                    n = s = 0
                }
                c = 1,
                ...
                i *= g,
                s *= g),
                (C = D * K) && (t = n * (g = Math.cos(C)) + o * (v = Math.sin(C)),
                y = r * g + a * v,
                d = c * v,
                f = h * v,
                o = n * -v + o * g,
                ...
                D || j || 1 !== E ? (b += _ + (d < m && -m < d ? w : d) + _ + (f < m && -m < f ? w : f) + _ + (o < m && -m < o ? w : o),
                b += _ + (a < m && -m < a ? w : a) + _ + (c < m && -m < c ? w : c) + _ + (h < m && -m < h ? w : h) + _) : b += ",0,0,0,0,1,0,",
        ...
        ;
        function Ze(e) {
            var t, i = this.t, n = i.filter || ue(this.data, "filter") || "", o = this.s + this.c * e | 0;
            100 == o && (t = -1 === n.indexOf("atrix(") && -1 === n.indexOf("radient(") && -1 === n.indexOf("oader(") ? (i.removeAttribute("filter"),
            !ue(this.data, "filter")) : (i.filter = n.replace($, ""),
            !0)),
            t || (this.xn1 && (i.filter = n = n || "alpha(opacity=" + o + ")"),
            -1 === n.indexOf("pacity") ? 0 == o && this.xn1 || (i.filter = n + " alpha(opacity=" + o + ")") : i.filter = n.replace(B, "opacity=" + o))
        }
        function et(e) {
        ...
        De("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
            parser: function(e, t, i, n, s, a, l) {
                ...
                d && (l.scale = d(A, e));
                var c, u, f, h, p, m, g, v, y, b = e._gsTransform, x = e.style, k = Fe.length, T = l, S = {}, C = "transformOrigin", O = Ve(e, o, !0, T.parseTransform), D = T.transform && ("function" == typeof T.transform ? T.transform(A, P) : T.transform);
                if (O.skewType = T.skewType || O.skewType || r.defaultSkewType,
                n._transform = O,
                ...
                D && "string" == typeof D && Re)
                    ...
                    u.display = "block",
                    u.position = "absolute",
                    -1 !== D.indexOf("%") && (u.width = ue(e, "width"),
                    ...
                    c.x -= O.xOffset,
                    c.y -= O.yOffset,
                    (T.transformOrigin || T.svgOrigin) && (D = {},
                    Ae(e, ge(T.transformOrigin), D, T.svgOrigin, T.smoothOrigin, !0),
                    m = D.xOrigin,
                    g = D.yOrigin,
                    ...
                    c.xPercent = _(T.x, O.xPercent)),
                    "string" == typeof T.y && -1 !== T.y.indexOf("%") && (c.y = 0,
                    c.yPercent = _(T.y, O.yPercent)),
                    c.rotation = w("rotation"in T ? T.rotation : "shortRotation"in T ? T.shortRotation + "_short" : O.rotation, O.rotation, "rotation", S),
                    $e && (c.rotationX = w("rotationX"in T ? T.rotationX : "shortRotationX"in T ? T.shortRotationX + "_short" : O.rotationX || 0, O.rotationX, "rotationX", S),
                ...
                for ($e && null != T.force3D && (O.force3D = T.force3D,
                h = !0),
                (f = O.force3D || O.z || O.rotationX || O.rotationY || c.z || c.rotationX || c.rotationY || c.perspective) || null == T.scale || (c.scaleZ = 1); -1 < --k; )
                    (1e-6 < (D = c[y = Fe[k]] - O[y]) || D < -1e-6 || null != T[y] || null != ee[y]) && (h = !0,
                    s = new Te(O,y,O[y],D,s),
                    y in S && (s.e = S[y]),
                    s.xs0 = 0,
                    s.plugin = a,
                    n._overwriteProps.push(s.n));
                return D = "function" == typeof T.transformOrigin ? T.transformOrigin(A, P) : T.transformOrigin,
                O.svg && (D || T.svgOrigin) && (m = O.xOffset,
                g = O.yOffset,
                ...
                m === O.xOffset && g === O.yOffset || (s = xe(O, "xOffset", b ? m : O.xOffset, O.xOffset, s, C),
                s = xe(O, "yOffset", b ? g : O.yOffset, O.yOffset, s, C)),
                D = "0px 0px"),
                (D || $e && f && O.zOrigin) && (Re ? (h = !0,
                y = qe,
                ...
                s.xs0 = s.e = O.zOrigin) : s.xs0 = s.e = D) : ge(D + "", O)),
        ...
        De("borderRadius", {
            ...
            parser: function(e, t, i, s, r, a) {
                t = this.format(t);
                var l, d, c, u, f, h, m, g, v, y, b, _, w, x, k, T, S = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], C = e.style;
                for (v = parseFloat(e.offsetWidth),
                y = parseFloat(e.offsetHeight),
                l = t.split(" "),
                d = 0; d < S.length; d++)
                    this.p.indexOf("border") && (S[d] = p(S[d])),
                    -1 !== (f = u = ue(e, S[d], o, !1, "0px")).indexOf(" ") && (f = (u = f.split(" "))[0],
                    u = u[1]),
                    h = c = l[d],
                    m = parseFloat(f),
                    _ = f.substr((m + "").length),
                    "" === (b = (w = "=" === h.charAt(1)) ? (g = parseInt(h.charAt(0) + "1", 10),
                    h = h.substr(2),
                    g *= parseFloat(h),
                    h.substr((g + "").length - (g < 0 ? 1 : 0)) || "") : (g = parseFloat(h),
                    h.substr((g + "").length))) && (b = n[i] || _),
                    b !== _ && (x = fe(e, "borderLeft", m, _),
                    k = fe(e, "borderTop", m, _),
                    u = "%" === b ? (f = x / v * 100 + "%",
                    k / y * 100 + "%") : "em" === b ? (f = x / (T = fe(e, "borderLeft", 1, "em")) + "em",
                    k / T + "em") : (f = x + "px",
                    k + "px"),
                    w && (h = parseFloat(f) + g + b,
                    c = parseFloat(u) + g + b)),
        ...
        De("backgroundPosition", {
            defaultValue: "0 0",
            parser: function(e, t, i, n, s, r) {
                var a, l, d, c, u, f, h = "background-position", p = o || m(e), g = this.format((p ? j ? p.getPropertyValue(h + "-x") + " " + p.getPropertyValue(h + "-y") : p.getPropertyValue(h) : e.currentStyle.backgroundPositionX + " " + e.currentStyle.backgroundPositionY) || "0 0"), v = this.format(t);
                if (-1 !== g.indexOf("%") != (-1 !== v.indexOf("%")) && v.split(",").length < 2 && (f = ue(e, "backgroundImage").replace(G, "")) && "none" !== f) {
                    for (a = g.split(" "),
                    l = v.split(" "),
                    oe.setAttribute("src", f),
                    d = 2; -1 < --d; )
                        (c = -1 !== (g = a[d]).indexOf("%")) != (-1 !== l[d].indexOf("%")) && (u = 0 === d ? e.offsetWidth - oe.width : e.offsetHeight - oe.height,
                        a[d] = c ? parseFloat(g) / 100 * u + "px" : parseFloat(g) / u * 100 + "%");
                    g = a.join(" ")
                }
        ...
        De("clip", {
            ...
            parser: function(e, t, i, n, s, r) {
                var a, l, d;
                return t = j < 9 ? (l = e.currentStyle,
                d = j < 8 ? " " : ",",
                a = "rect(" + l.clipTop + d + l.clipRight + d + l.clipBottom + d + l.clipLeft + ")",
                this.format(t).split(",").join(d)) : (a = this.format(ue(e, this.p, o, !1, this.dflt)),
                this.format(t)),
        ...
        De("border", {
            ...
            parser: function(e, t, i, n, s, r) {
                var a = ue(e, "borderTopWidth", o, !1, "0px")
                  ...
                  , d = l[0].replace(R, "");
                return "px" !== d && (a = parseFloat(a) / fe(e, "borderTopWidth", 1, d) + d),
        ...
        De("opacity,alpha,autoAlpha", {
            ...
            parser: function(e, t, i, n, s, r) {
                ...
                ae ? s = new Te(l,"opacity",a,t - a,s) : ((s = new Te(l,"opacity",100 * a,100 * (t - a),s)).xn1 = d ? 1 : 0,
                l.zoom = 1,
                s.type = 2,
                ...
                s.plugin = r,
                s.setRatio = Ze),
                d && ((s = new Te(l,"visibility",0,0,s,-1,null,!1,0,0 !== a ? "inherit" : "hidden",0 === t ? "hidden" : "inherit")).xs0 = "inherit",
                n._overwriteProps.push(s.n),
        ...
        var tt = function(e, t) {
            ...
            e.removeProperty(t.replace(N, "-$1").toLowerCase())) : e.removeAttribute(t))
        };
        function it(e) {
            if ((1 === e || 0 === e) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                var t, i, n, o, s, r = this.t.style, a = l.transform.parse;
                if ("all" === this.e)
                    o = !(r.cssText = "");
                else
                    for (n = (t = this.e.split(" ").join("").split(",")).length; -1 < --n; )
                        i = t[n],
                        l[i] && (l[i].parse === a ? o = !0 : i = "transformOrigin" === i ? qe : l[i].p),
                        tt(r, i);
                o && (tt(r, Re),
        ...
        for (De("className", {
            parser: function(e, t, n, s, r, a, l) {
                var d, c, u, f, h, p = e.getAttribute("class") || "", m = e.style.cssText;
                if ((r = s._classNamePT = new Te(e,n,0,0,r,2)).setRatio = et,
                r.pr = -11,
                i = !0,
                r.b = p,
                c = g(e, o),
                ...
                return (e._gsClassPT = r).e = "=" !== t.charAt(1) ? t : p.replace(new RegExp("(?:\\s|^)" + t.substr(2) + "(?![\\w-])"), "") + ("+" === t.charAt(0) ? " " + t.substr(2) : ""),
        ...
        De("clearProps", {
            parser: function(e, t, n, o, s) {
                return (s = new Te(e,n,0,0,s,2)).setRatio = it,
                s.e = t,
                s.pr = -10,
                s.data = o._tween,
                i = !0,
        ...
        d._onInitTween = function(e, t, a, d) {
            ...
            if (S && "" === x.zIndex && ("auto" !== (c = ue(e, "zIndex", o)) && "" !== c || this._addLazySet(x, "zIndex", 0)),
            "string" == typeof t && (h = x.cssText,
            c = g(e, o),
            x.cssText = h + ";" + t,
            c = v(e, c, g(e)).difs,
            !ae && q.test(t) && (c.opacity = parseFloat(RegExp.$1)),
            t = c,
            x.cssText = h),
            ...
            if (i) {
                for (; u; ) {
                    ...
                    f = h; f && f.pr > u.pr; )
                        f = f._next;
                    (u._prev = f ? f._prev : p) ? u._prev._next = u : h = u,
                    (u._next = f) ? f._prev = u : p = u,
                    u = y
                }
                this._firstPT = h
            }
        ...
        d.parse = function(e, t, i, s) {
            ...
            for (r in t) {
                if (f = t[r],
                a = l[r],
                "function" != typeof f || a && a.allowFunc || (f = f(A, P)),
                a)
                    i = a.parse(e, f, r, this, i, s, t);
                else {
                    if ("--" === r.substr(0, 2)) {
                    ...
                    u = ue(e, r, o) + "",
                    v = "string" == typeof f,
                    "color" === r || "fill" === r || "stroke" === r || -1 !== r.indexOf("Color") || v && H.test(f) ? (v || (f = (3 < (f = ye(f)).length ? "rgba(" : "rgb(") + f.join(",") + ")"),
                    i = Se(_, r, u, f, !0, "transparent", i, 0, s)) : v && V.test(f) ? i = Se(_, r, u, f, !0, null, i, 0, s) : (p = (d = parseFloat(u)) || 0 === d ? u.substr((d + "").length) : "",
                    "" !== u && "auto" !== u || (p = "width" === r || "height" === r ? (d = y(e, r, o),
                    "px") : "left" === r || "top" === r ? (d = he(e, r, o),
                    "px") : (d = "opacity" !== r ? 0 : 1,
                    "")),
                    "" === (g = (b = v && "=" === f.charAt(1)) ? (c = parseInt(f.charAt(0) + "1", 10),
                    f = f.substr(2),
                    c *= parseFloat(f),
                    f.replace(R, "")) : (c = parseFloat(f),
                    v ? f.replace(R, "") : "")) && (g = r in n ? n[r] : p),
                    f = c || 0 === c ? (b ? c + d : c) + g : t[r],
                    p === g || "" === g && "lineHeight" !== r || !c && 0 !== c || !d || (d = fe(e, r, d, p),
                    "%" === g ? (d /= fe(e, r, 100, "%") / 100,
                    !0 !== t.strictUnits && (u = d + "%")) : "em" === g || "rem" === g || "vw" === g || "vh" === g ? d /= fe(e, r, 1, g) : "px" !== g && (c = fe(e, r, c, g),
                    g = "px"),
                    b && (c || 0 === c) && (f = c + d + g)),
                    b && (c += d),
                    !d && 0 !== d || !c && 0 !== c ? void 0 !== _[r] && (f || f + "" != "NaN" && null != f) ? (i = new Te(_,r,c || d || 0,0,i,-1,r,!1,0,u,f)).xs0 = "none" !== f || "display" !== r && -1 === r.indexOf("Style") ? f : u : h("invalid " + r + " tween value: " + t[r]) : (i = new Te(_,r,d,c - d,i,0,r,!1 !== T && ("px" === g || "zIndex" === r),0,u,f)).xs0 = g)
                }
        ...
        d._kill = function(t) {
            ...
            for (t.className && (i = this._classNamePT) && ((o = i.xfirst) && o._prev ? this._linkCSSP(o._prev, i._next, o._prev._prev) : o === this._firstPT && (this._firstPT = i._next),
        ...
        var ot = function(e, t, i) {
            ...
            if (e.slice)
                ...
                for (o = (n = e.childNodes).length; -1 < --o; )
                    ...
                    s.style && (t.push(g(s)),
                    i && i.push(s)),
                    1 !== r && 9 !== r && 11 !== r || !s.childNodes.length || ot(s, t, i)
        };
        return r.cascadeTo = function(e, i, n) {
            var o, s, r, a, l = t.to(e, i, n), d = [l], c = [], u = [], f = [], h = t._internals.reservedProps;
    ...
    (i = _gsScope._gsDefine.plugin({
        ...
        var i, n, o, s, r = this._tween, a = r.vars.roundProps, l = {}, d = r._propLookup.roundProps;
        ...
        for (s in l)
            for (i = r._firstPT; i; )
                n = i._next,
                i.pg ? i.t._mod(l) : i.n === s && (2 === i.f && i.t ? t(i.t._firstPT, l[s]) : (this._add(i.t, s, i.s, i.c, l[s]),
                n && (n._prev = i._prev),
    ...
    _gsScope._gsDefine.plugin({
        ...
        init: function(e, t, i, n) {
            ...
            for (o in t)
                "useRadians" !== o && ("function" == typeof (a = t[o]) && (a = a(n, e)),
                s = (d = (a + "").split("_"))[0],
                ...
                d.length && (-1 !== (s = d.join("_")).indexOf("short") && (l %= c) != l % (c / 2) && (l = l < 0 ? l + c : l - c),
                -1 !== s.indexOf("_cw") && l < 0 ? l = (l + 9999999999 * c) % c - (l / c | 0) * c : -1 !== s.indexOf("ccw") && 0 < l && (l = (l - 9999999999 * c) % c - (l / c | 0) * c)),
                (1e-6 < l || l < -1e-6) && (this._addTween(e, o, r, r + l, o),
                this._overwriteProps.push(o)));
            return !0
        },
        set: function(e) {
    ...
    _gsScope._gsDefine("easing.Back", ["easing.Ease"], (function(e) {
        ...
        var s, r, a, l, d = _gsScope.GreenSockGlobals || _gsScope, c = d.com.greensock, u = 2 * Math.PI, f = Math.PI / 2, h = c._class, p = e.register || function() {}
        ...
        ), !0)).prototype = new e).constructor = s,
        v.getRatio = function(e) {
        ...
        ), !0)).prototype = new e).constructor = r,
        v.getRatio = function(e) {
        ...
        (v = (a = h("easing.RoughEase", (function(t) {
            for (var i, o, s, r, a, l, d = (t = t || {}).taper || "none", c = [], u = 0, f = 0 | (t.points || 20), h = f, p = !1 !== t.randomize, m = !0 === t.clamp, g = t.template instanceof e ? t.template : null, v = "number" == typeof t.strength ? .4 * t.strength : .4; -1 < --h; )
                i = p ? Math.random() : 1 / f * h,
                o = g ? g.getRatio(i) : i,
                s = "none" === d ? v : "out" === d ? (r = 1 - i) * r * v : "in" === d ? i * i * v : (r = i < .5 ? 2 * i : 2 * (1 - i)) * r * .5 * v,
                p ? o += Math.random() * s - .5 * s : h % 2 ? o += .5 * s : o -= .5 * s,
                m && (1 < o ? o = 1 : o < 0 && (o = 0)),
                c[u++] = {
                    x: i,
                    y: o
        ...
        ), !0)).prototype = new e).constructor = a,
        v.getRatio = function(e) {
            var t = this._prev;
            if (e > t.t) {
                for (; t.next && e >= t.t; )
        ...
        ,
        a.ease = new a,
        i("Bounce", t("BounceOut", (function(e) {
...
function(e, t) {
    ...
    function l() {}
    var d, c, u, f, h, p, m, g = r("com.greensock"), v = 1e-8, y = (p = Object.prototype.toString,
    m = p.call([]),
    function(e) {
        return null != e && (e instanceof Array || "object" == typeof e && !!e.push && p.call(e) === m)
    }
    ), b = {}, _ = function(n, s, a, l) {
        this.sc = b[n] ? b[n].sc : [],
        (b[n] = this).gsClass = null,
        this.func = a;
        var d = [];
        this.check = function(c) {
            for (var u, f, h, p, m = s.length, g = m; -1 < --m; )
                (u = b[s[m]] || new _(s[m],[])).gsClass ? (d[m] = u.gsClass,
                g--) : c && u.sc.push(this);
            if (0 === g && a) {
                if (h = (f = ("com.greensock." + n).split(".")).pop(),
                p = r(f.join("."))[h] = this.gsClass = a.apply(a, d),
                l)
                    if (o[h] = i[h] = p,
                    "undefined" != typeof module && module.exports)
                        if (n === t)
                            for (m in module.exports = i[t] = p,
                            i)
                                p[m] = i[m];
                        else
                            i[t] && (i[t][h] = p);
    ...
    var k = [0, 0, 1, 1]
      ...
      , C = T.register = function(e, t, i, n) {
        for (var o, s, r, a, l = t.split(","), d = l.length, c = (i || "easeIn,easeOut,easeInOut").split(","); -1 < --d; )
            ...
            r = c.length; -1 < --r; )
                a = c[r],
                S[s + "." + a] = S[a + s] = o[a] = e.getRatio ? e : e[a] || new e
    }
    ;
    for ((u = T.prototype)._calcEnd = !1,
    ...
    ,
    c = (d = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"]).length; -1 < --c; )
        u = d[c] + ",Power" + c,
        C(new T(null,null,1,c), u, "easeOut", !0),
        C(new T(null,null,2,c), u, "easeIn" + (0 === c ? ",easeNone" : "")),
        C(new T(null,null,3,c), u, "easeInOut");
    S.linear = g.easing.Linear.easeIn,
    S.swing = g.easing.Quad.easeInOut;
    ...
    (u = O.prototype).addEventListener = function(e, t, i, n, o) {
        o = o || 0;
        var s, r, a = this._listeners[e], l = 0;
        for (this !== f || h || f.wake(),
    ...
    u.dispatchEvent = function(e) {
        ...
        if (o)
            for (1 < (t = o.length) && (o = o.slice(0)),
            i = this._eventTarget; -1 < --t; )
                (n = o[t]) && (n.up ? n.c.call(n.s || i, {
                    type: e,
                    target: i
                }) : n.c.call(n.s || i))
    }
    ...
    var D = e.requestAnimationFrame
      ...
      , A = P();
    for (c = (d = ["ms", "moz", "webkit", "o"]).length; -1 < --c && !D; )
        D = e[d[c] + "RequestAnimationFrame"],
        j = e[d[c] + "CancelAnimationFrame"] || e[d[c] + "CancelRequestAnimationFrame"];
    x("Ticker", (function(e, t) {
        var i, o, s, r, a, d = this, c = P(), u = !(!1 === t || !D) && "auto", p = 500, m = 33, g = function(e) {
            var t, n, l = P() - A;
            p < l && (c += l - m),
            A += l,
            d.time = (A - c) / 1e3,
        ...
        d.lagSmoothing = function(e, t) {
            return arguments.length ? (p = e || 1e8,
            void (m = Math.min(t, p, 0))) : p < 1e8
        }
        ,
        d.sleep = function() {
            null != s && ((u && j ? j : clearTimeout)(s),
            o = l,
            s = null,
            d === f && (h = !1))
        }
        ...
        ,
        d.fps = function(e) {
            return arguments.length ? (r = 1 / ((i = e) || 60),
            a = this.time + r,
            void d.wake()) : i
        }
        ,
    ...
    u.eventCallback = function(e, t, i, n) {
        if ("on" === (e || "").substr(0, 2)) {
            ...
            o[e + "Params"] = y(i) && -1 !== i.join("").indexOf("{self}") ? this._swapSelfInParams(i) : i,
            o[e + "Scope"] = n),
        ...
        if (this._timeline) {
            ...
            this._timeline.smoothChildTiming) {
                ...
                var n = this._totalDuration
                  , o = this._timeline;
                if (n < e && !i && (e = n),
                this._startTime = (this._paused ? this._pauseTime : o._time) - (this._reversed ? n - e : e) / this._timeScale,
            ...
            this._gc && this._enabled(!0, !1),
            this._totalTime === e && 0 !== this._duration || (q.length && ee(),
            this.render(e, t, !1),
            q.length && ee())
        }
        return this
    ...
    u.paused = function(e) {
        ...
        return e != this._paused && n && (h || e || f.wake(),
    ...
    u.add = u.insert = function(e, t, i, n) {
        ...
        o = this._last,
        this._sortChildren)
            for (s = e._startTime; o && o._startTime > s; )
                o = o._prev;
        return o ? (e._next = o._next,
        o._next = e) : (e._next = this._first,
        this._first = e),
    ...
    u.render = function(e, t, i) {
        ...
        for (this._totalTime = this._time = this._rawPrevTime = e; o; )
            n = o._next,
            (o._active || e >= o._startTime && !o._paused && !o._gc) && (o._reversed ? o.render((o._dirty ? o.totalDuration() : o._totalDuration) - (e - o._startTime) * o._timeScale, t, i) : o.render((e - o._startTime) * o._timeScale, t, i)),
            o = n
    }
    ,
    u.rawTime = function() {
    ...
    var L = x("TweenLite", (function(t, i, n) {
        ...
        var o, s, r, l = t.jquery || t.length && t !== e && t[0] && (t[0] === e || t[0].nodeType && t[0].style && !t.nodeType), d = this.vars.overwrite;
        if (this._overwrite = d = null == d ? J[L.defaultOverwrite] : "number" == typeof d ? d >> 0 : J[d],
        (l || t instanceof Array || t.push && y(t)) && "number" != typeof t[0])
            for (this._targets = r = a(t),
            this._propLookup = [],
            this._siblings = [],
            o = 0; o < r.length; o++)
                (s = r[o]) ? "string" != typeof s ? s.length && s !== e && s[0] && (s[0] === e || s[0].nodeType && s[0].style && !s.nodeType) ? (r.splice(o--, 1),
                this._targets = r = r.concat(a(s))) : (this._siblings[o] = ie(s, this, !1),
                1 === d && 1 < this._siblings[o].length && ne(s, this, null, 1, this._siblings[o])) : "string" == typeof (s = r[o--] = L.selector(s)) && r.splice(o + 1, 1) : r.splice(o--, 1);
        else
            this._propLookup = {},
            this._siblings = ie(t, this, !1),
            1 === d && 1 < this._siblings.length && ne(t, this, null, 1, this._siblings);
        (this.vars.immediateRender || 0 === i && 0 === this._delay && !1 !== this.vars.immediateRender) && (this._time = -v,
    ...
    function R(e, t, i, n) {
        ...
        a = 0; a < l; a++)
            ...
            c === o[a] || o.length <= a ? h += c : (h && (u.push(h),
            h = ""),
            r = parseFloat(o[a]),
            u.push(r),
            u._firstPT = {
    ...
    function B(e, t, i, n, o, s, r, a, l) {
        ...
        return "number" == typeof u && ("number" == typeof n || f) || (r || isNaN(u) || !f && isNaN(n) || "boolean" == typeof u || "boolean" == typeof n ? (h.fp = r,
        h = {
    ...
    var q = []
      ...
      , ee = Y.lazyRender = function() {
        ...
        for ($ = {},
        e = 0; e < i; e++)
            (t = q[e]) && !1 !== t._lazy && (t.render(t._lazy[0], t._lazy[1], !0),
            t._lazy = !1);
        q.length = 0
    }
    ;
    ...
    E._updateRoot = L.render = function() {
        ...
        V.render((f.frame - V._startTime) * V._timeScale, !1, !1),
        q.length && ee(),
        f.frame >= Z) {
            for (i in Z = f.frame + (parseInt(L.autoSleep, 10) || 120),
            U) {
    ...
    var ie = function(e, t, i) {
      ...
      , ne = function(e, t, i, n, o) {
        ...
        if (1 === n || 4 <= n) {
            ...
            s = 0; s < l; s++)
                if ((a = o[s]) !== t)
                    a._gc || a._kill(null, e, t) && (r = !0);
                else if (5 === n)
                    break;
            return r
        }
        var d, c = t._startTime + v, u = [], f = 0, h = 0 === t._duration;
        for (s = o.length; -1 < --s; )
            (a = o[s]) === t || a._gc || a._paused || (a._timeline !== t._timeline ? (d = d || oe(t, 0, h),
            0 === oe(a, d, h) && (u[f++] = a)) : a._startTime <= c && a._startTime + a.totalDuration() / a._timeScale > c && ((h || !a._initted) && c - a._startTime <= 2e-8 || (u[f++] = a)));
        for (s = f; -1 < --s; )
            if (l = (a = u[s])._firstPT,
    ...
    u._init = function() {
        var e, t, i, n, o, s, r = this.vars, a = this._overwrittenProps, l = this._duration, d = !!r.immediateRender, c = r.ease, u = this._startAt;
        if (r.startAt) {
            for (n in u && (u.render(-1, !0),
            u.kill()),
            o = {},
            r.startAt)
                o[n] = r.startAt[n];
        ...
        if (this._ease = c = c ? c instanceof T ? c : "function" == typeof c ? new T(c,r.easeParams) : S[c] || L.defaultEase : L.defaultEase,
        ...
        if (t && L._onPluginEvent("_onInitAllProps", this),
    ...
    u._initProps = function(t, i, n, o, s) {
        ...
        this.vars.css || t.style && t !== e && t.nodeType && G.css && !1 !== this.vars.autoCSS && function(e, t) {
            var i, n = {};
            for (i in e)
                Q[i] || i in t && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!G[i] || G[i] && G[i]._autoCSS) || (n[i] = e[i],
                delete e[i]);
            e.css = n
        }(this.vars, t),
        this.vars)
            if (u = this.vars[r],
            Q[r])
                u && (u instanceof Array || u.push && y(u)) && -1 !== u.join("").indexOf("{self}") && (this.vars[r] = u = this._swapSelfInParams(u, this));
                ...
                a = d._overwriteProps.length; -1 < --a; )
                    i[d._overwriteProps[a]] = this._firstPT;
                (d._priority || d._onInitAllProps) && (l = !0),
                (d._onDisable || d._onEnable) && (this._notifyPluginsOfEnabled = !0),
                c._next && (c._next._prev = c)
            } else
                i[r] = B.call(this, t, r, "get", u, r, 0, null, this.vars.stringFilter, s);
        return o && this._kill(o, t) ? this._initProps(t, i, n, o, s) : 1 < this._overwrite && this._firstPT && 1 < n.length && ne(t, this, i, this._overwrite, n) ? (this._kill(i, t),
        this._initProps(t, i, n, o, s)) : (this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration) && ($[t._gsTweenID] = !0),
        l)
    }
    ,
    u.render = function(e, t, i) {
        var n, o, s, r, a = this, l = a._time, d = a._duration, c = a._rawPrevTime;
        if (d - v <= e && 0 <= e)
            ...
            0 !== d || !a._initted && a.vars.lazy && !i || (a._startTime === a._timeline._duration && (e = 0),
            (c < 0 || e <= 0 && -v <= e || c === v && "isPause" !== a.data) && c !== e && (i = !0,
            v < c && (o = "onReverseComplete")),
            a._rawPrevTime = r = !t || e || c === e ? e : v);
        else if (e < v)
            a._totalTime = a._time = 0,
            a.ratio = a._ease._calcEnd ? a._ease.getRatio(0) : 0,
            (0 !== l || 0 === d && 0 < c) && (o = "onReverseComplete",
            n = a._reversed),
            -v < e ? e = 0 : e < 0 && (a._active = !1,
            0 !== d || !a._initted && a.vars.lazy && !i || (0 <= c && (c !== v || "isPause" !== a.data) && (i = !0),
            a._rawPrevTime = r = !t || e || c === e ? e : v)),
        ...
        a._easeType) {
            ...
            a.ratio = 1 === f ? 1 - u : 2 === f ? u : e / d < .5 ? u / 2 : 1 - u / 2
        } else
            a.ratio = a._ease.getRatio(e / d);
        if (a._time !== l || i) {
            if (!a._initted) {
                if (a._init(),
                !a._initted || a._gc)
            ...
            0 === l && (a._startAt && (0 <= e ? a._startAt.render(e, !0, i) : o = o || "_dummyGS"),
            !a.vars.onStart || 0 === a._time && 0 !== d || t || a._callback("onStart")),
            s = a._firstPT; s; )
                s.f ? s.t[s.p](s.c * a.ratio + s.s) : s.t[s.p] = s.c * a.ratio + s.s,
                s = s._next;
            a._onUpdate && (e < 0 && a._startAt && -1e-4 !== e && a._startAt.render(e, !0, i),
            t || (a._time !== l || n || i) && a._callback("onUpdate")),
            !o || a._gc && !i || (e < 0 && a._startAt && !a._onUpdate && -1e-4 !== e && a._startAt.render(e, !0, i),
    ...
    u._kill = function(e, t, i) {
        ...
        var n, o, s, r, a, l, d, c, u, f = i && this._time && i._startTime === this._startTime && this._timeline === i._timeline, h = this._firstPT;
        if ((y(t) || I(t)) && "number" != typeof t[0])
            ...
            if (a) {
                if (d = e || a,
                c = e !== o && "all" !== o && e !== a && ("object" != typeof e || !e._tempKill),
                i && (L.onOverwrite || this.vars.onOverwrite)) {
                    for (s in d)
                        a[s] && (u = u || []).push(s);
                    if ((u || !e) && !te(this, i, t, u))
                        return !1
                }
                for (s in d)
                    (r = a[s]) && (f && (r.f ? r.t[r.p](r.s) : r.t[r.p] = r.s,
                    l = !0),
    ...
    u._enabled = function(e, t) {
        ...
        e && this._gc) {
            ...
            if (n)
                ...
                this._siblings = ie(this.target, this, !0)
        }
        return E.prototype._enabled.call(this, e, t),
        !(!this._notifyPluginsOfEnabled || !this._firstPT) && L._onPluginEvent(e ? "_onEnable" : "_onDisable", this)
    }
    ,
    L.to = function(e, t, i) {
        return new L(e,t,i)
    ...
    L.getTweensOf = function(e, t) {
        if (null == e)
            return [];
        var i, n, o, s;
        if (e = "string" != typeof e ? e : L.selector(e) || e,
        (y(e) || I(e)) && "number" != typeof e[0]) {
            for (i = e.length,
            n = []; -1 < --i; )
    ...
    L.killTweensOf = L.killDelayedCallsTo = function(e, t, i) {
        "object" == typeof t && (i = t,
        t = !1);
        for (var n = L.getTweensOf(e, t), o = n.length; -1 < --o; )
            n[o]._kill(i, e)
    }
    ;
    ...
    se.activate = function(e) {
        for (var t = e.length; -1 < --t; )
            e[t].API === se.API && (G[(new e[t])._propName] = e[t]);
        return !0
    }
    ,
    w.plugin = function(e) {
        ...
        var t, i = e.propName, n = e.priority || 0, o = e.overwriteProps, s = {
            init: "_onInitTween",
            set: "setRatio",
            kill: "_kill",
            round: "_mod",
        ...
        ), !0 === e.global), a = r.prototype = new se(i);
        for (t in (a.constructor = r).API = e.API,
        s)
...
function(e) {
    ...
    (void 0 !== LS_GSAP ? LS_GSAP : window).SplitType = function(e, t, i) {
        ...
        function r(e, t, i) {
            for (var s = Object(e), r = o(s) ? s : n(d = s) && "[object Object]" === Object.prototype.toString.call(d) ? g(s) : [s], a = parseInt(r.length) || 0, l = 0; l < a; l++)
                t.call(i, r[l], l, s);
            var d
        }
        function a(e, t) {
        ...
        function c(e, i) {
            return this instanceof c ? (this.isSplit = !1,
            this.settings = a(w, i),
            this.elements = function(e) {
                var i, n, r, a, l, d, c = [];
                if ("string" == typeof e && (e = "#" !== (i = e.trim())[0] || /[^\w]/.test(n = i.slice(1)) ? t.querySelectorAll(i) : t.getElementById(n)),
                i || s(e))
                ...
                if (o(e))
                    ...
                    r = e.length; l < r; l++)
                        if (o(e[l]))
                            for (d = 0,
                            a = e[l].length; d < a; d++)
                                s(e[l][d]) && c.push(e[l][d]);
                        else
                            s(e[l]) && c.push(e[l]);
                return c
            }(e),
            void (this.elements.length && (this.originals = this.elements.map((function(e) {
        ...
        if (t.addEventListener && Function.prototype.bind) {
            ...
            c.prototype.split = function(t) {
                ...
                r(this.elements, (function(t) {
                    (function(t) {
                        var i, n, o, s, a = this.settings, c = a.tagName, u = "B" + +new Date + "R", f = a.split, h = -1 !== f.indexOf("lines"), g = -1 !== f.indexOf("words"), v = -1 !== f.indexOf("chars"), y = "absolute" === a.position || !0 === a.absolute, w = d("div"), x = [], k = [];
                        if (o = h ? d("div") : b(),
                        w.innerHTML = t.innerHTML.replace(/<br\s*\/?>/g, " " + u + " "),
                        s = w.textContent.replace(/\s+/g, " ").trim().split(" ").map((function(e) {
                            if (e === u)
                                return o.appendChild(d("br")),
                                null;
                            if (v) {
                        ...
                        y || h) {
                            ...
                            r(P, (function(e) {
                                if (e !== o) {
                                    ...
                                    h && i && ((t = l(e).top = e.offsetTop) !== S && (S = t,
                                    I.push(T = [])),
                                    T.push(e)),
                                    y && (l(e).top = t || e.offsetTop,
                            ...
                            y && (t.style.width = t.style.width || j + "px",
                            t.style.height = D + "px",
                            r(P, (function(e) {
                                var t = "line" === l(e).type
            ...
            c.prototype.revert = function() {
                ...
                r(this.elements, (function(e) {
                    l(e).isSplit && l(e).html && (e.innerHTML = l(e).html,
...
"object" == typeof LS_Meta && LS_Meta.fixGSAP && (window.GreenSockGlobals = null,
...
window._layerSlider = {
    ...
    showNotice: function(e, t, i, n) {
        var o, s, r, a = jQuery(e), l = "ls-issue-" + t;
        switch (t) {
        case "jquery":
        ...
        case "oldjquery":
            r = "Old jQuery issue",
            s = "It looks like you are using an old version (" + i + ") of the jQuery library. LayerSlider requires at least version " + n + " or newer. Please update jQuery to 1.10.x or higher. Important: Please do not use the jQuery Updater plugin on WordPress as it can cause issues in certain cases."
        }
        a.each((function() {
            (o = jQuery(this)).hasClass(l) || (o.addClass(l),
            jQuery('<div class="ls-slider-notification"><i class="ls-slider-notification-logo">!</i><strong>LayerSlider: ' + r + "</strong><span>" + s + "</span></div>").insertBefore(o))
        }
        ))
    },
...
function(e) {
    ...
    t.prototype.lazyLoad = function() {
        ...
        "anticipated" === s.options.lazyLoad)
            for (var r = n - 1, a = o, l = s.$slider.find(".slick-slide"), d = 0; d < s.options.slidesToScroll; d++)
    ...
    t.prototype.slideHandler = function(e, t, i) {
        ...
        !(!0 === d.animating && !0 === d.options.waitForAnimate || !0 === d.options.fade && d.currentSlide === e))
            ...
            !1 === d.options.infinite && !1 === d.options.centerMode && (e < 0 || e > d.getDotCount() * d.options.slidesToScroll))
                ...
                o = n < 0 ? d.slideCount % d.options.slidesToScroll != 0 ? d.slideCount - d.slideCount % d.options.slidesToScroll : d.slideCount + n : n >= d.slideCount ? d.slideCount % d.options.slidesToScroll != 0 ? 0 : n - d.slideCount : n,
                d.animating = !0,
